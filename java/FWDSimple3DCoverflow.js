(function() {
    var e = function(t, n, r, i, s) {
        ...
        this.init = function() {
            ...
            o.setWidth(o.totalWidth);
            o.setHeight(o.totalHeight)
        }
        ;
        this.setupMainContainers = function() {
            o.bkDO = new FWDS3DCovSimpleDisplayObject("div");
            o.addChild(o.bkDO);
            o.textDO = new FWDS3DCovSimpleDisplayObject("div");
            o.textDO.getStyle().whiteSpace = "nowrap";
            o.textDO.setBackfaceVisibility();
            o.textDO.setOverflow("visible");
            o.textDO.screen.className = "categoriesMenuText";
            o.textDO.getStyle().color = o.normalColor_str;
            o.textDO.getStyle().fontSmoothing = "antialiased";
            o.textDO.getStyle().webkitFontSmoothing = "antialiased";
            o.textDO.getStyle().textRendering = "optimizeLegibility";
            if (FWDS3DCovUtils.isIEAndLessThen9) {
                o.textDO.screen.innerText = o.label_str
            } else {
                o.textDO.setInnerHTML(o.label_str)
            }
            o.addChild(o.textDO);
            o.dumyDO = new FWDS3DCovSimpleDisplayObject("div");
            if (FWDS3DCovUtils.isIE) {
                o.dumyDO.setBkColor("#FF0000");
                o.dumyDO.setAlpha(0)
            }
            o.addChild(o.dumyDO);
            if (o.isMobile) {
                if (o.hasPointerEvent) {
            ...
            o.textPosId = setTimeout(o.positionText, 10)
        }
        ;
        this.onMouseOver = function(e) {
            ...
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                FWDS3DCovModTweenMax.killTweensOf(o.textDO);
        ...
        this.setSelectedState = function(e) {
            if (e) {
                FWDS3DCovModTweenMax.to(o.textDO.screen, .6, {
                    css: {
                        color: o.textSelectedColor_str
                    },
                    ease: Quart.easeOut
                })
            } else {
                o.textDO.getStyle().color = o.textSelectedColor_str
            }
        }
        ;
        this.setNormalState = function(e) {
            if (e) {
                FWDS3DCovModTweenMax.to(o.textDO.screen, .6, {
                    css: {
                        color: o.textNormalColor_str
                    },
                    ease: Quart.easeOut
                })
            } else {
                o.textDO.getStyle().color = o.textNormalColor_str
            }
        }
        ;
        this.positionText = function() {
            o.totalWidth = o.textDO.getWidth() + 4;
            o.setWidth(o.totalWidth);
            o.dumyDO.setWidth(o.totalWidth);
            o.dumyDO.setHeight(o.totalHeight);
            o.bkDO.setWidth(o.totalWidth);
            o.bkDO.setHeight(o.totalHeight);
            o.textDO.setX(2);
            if (FWDS3DCovUtils.isIEAndLessThen9 || FWDS3DCovUtils.isSafari) {
                o.textDO.setY(Math.round((o.totalHeight - o.textDO.getHeight()) / 2) - 1)
            } else {
                o.textDO.setY(Math.round((o.totalHeight - o.textDO.getHeight()) / 2))
            }
            o.textDO.setHeight(o.totalHeight + 2);
            o.setNormalState()
        }
        ;
        ...
        this.destroy = function() {
            if (o.isMobile) {
                if (o.hasPointerEvent) {
                    ...
                    o.screen.removeEventListener("touchstart", o.onMouseClick)
                }
            ...
            FWDS3DCovModTweenMax.killTweensOf(o.textDO.screen);
            FWDS3DCovModTweenMax.killTweensOf(o.bkDO.screen);
            o.textDO.destroy();
            o.bkDO.destroy();
            o.dumyDO.destroy();
            o.bkDO = null ;
            ...
            o.dumyDO = null ;
            o.label_str = null ;
            o.normalColor_str = null ;
            o.textSelectedColor_str = null ;
            o.disabledColor_str = null ;
            o.setInnerHTML("");
            u.destroy();
            o = null ;
            u = null ;
    ...
    e.CLICK = "onClick";
    e.prototype = null ;
    window.FWDS3DCovCategoriesButton = e
}
)(window);
(function(e) {
    var t = function(n, r, i, s, o, u, a, f) {
        ...
        this.catColorN = a;
        this.catColorS = f;
        this.totalItems = l.labelsAr.length;
        this.buttonsAr = [];
        ...
        this.init = function() {
            l.setZ(2e5);
            l.buttonsHolderDO = new FWDS3DCovDisplayObject("div");
            l.addChild(l.buttonsHolderDO);
            var e;
            for (var t = 0; t < l.totalItems; t++) {
                FWDS3DCovCategoriesButton.setPrototype();
                e = new FWDS3DCovCategoriesButton(t,l.labelsAr[t],l.catColorN,l.catColorS,l.menuHeight);
                l.buttonsHolderDO.addChild(e);
                l.buttonsAr.push(e);
                e.addListener(FWDS3DCovCategoriesButton.CLICK, l.onButtonClick)
            }
            l.buttonsAr[l.curId].disable();
            l.setAlpha(0);
            l.positionButtonsId = setTimeout(l.positionButtons, 50)
        }
        ;
        this.positionButtons = function() {
            var e;
            l.totalWidth = l.buttonsAr[0].totalWidth;
            for (var t = 1; t < l.totalItems; t++) {
                e = l.buttonsAr[t];
                e.setX(l.buttonsAr[t - 1].getX() + l.buttonsAr[t - 1].totalWidth + 1);
                l.totalWidth += l.buttonsAr[t].totalWidth + 1
            }
            if (l.totalWidth > l.maxWidth) {
                l.setWidth(l.maxWidth);
                if (l.isMobile) {
                    l.setupMobileDrag()
                } else if (l.screen.addEventListener) {
                    l.screen.addEventListener("mousemove", l.onMouseMove)
                } else if (l.screen.attachEvent) {
                    l.screen.attachEvent("onmousemove", l.onMouseMove)
                }
            } else {
                l.setWidth(l.totalWidth)
            }
            l.setHeight(l.menuHeight);
            l.buttonsHolderDO.setWidth(l.totalWidth);
            l.buttonsHolderDO.setHeight(l.menuHeight);
            l.position()
        }
        ;
        this.position = function() {
            l.setX(Math.floor((l.parent.stageWidth - l.getWidth()) / 2));
            l.setY(l.catOffset);
            FWDS3DCovModTweenMax.to(l, .8, {
                alpha: 1
            })
        }
        ;
        this.onButtonClick = function(e) {
            l.curId = e.id;
            for (var n = 0; n < l.totalItems; n++) {
                button = l.buttonsAr[n];
                if (n == l.curId) {
                    button.disable()
                } else {
                    button.enable()
            ...
            l.dispatchEvent(t.CHANGE, {
                id: l.curId
            })
        }
        ;
        this.onMouseMove = function(e) {
            var t = FWDS3DCovUtils.getViewportMouseCoordinates(e);
            var r = (t.screenX - n.rect.left - l.getX()) / l.getWidth() * (l.getWidth() - l.totalWidth);
            FWDS3DCovModTweenMax.to(l.buttonsHolderDO, .2, {
                x: Math.floor(r)
            })
        }
        ;
        ...
        this.setupMobileDrag = function() {
            if (l.hasPointerEvent) {
                l.screen.addEventListener("MSPointerDown", l.mobileDragStartHandlerCat)
            } else {
        ...
        this.mobileDragStartTestCat = function(t) {
            var n = FWDS3DCovUtils.getViewportMouseCoordinates(t);
            l.lastPressedX = n.screenX;
            l.lastPressedY = n.screenY;
            l.curX = l.buttonsHolderDO.getX();
            e.addEventListener("touchmove", l.mobileDragMoveTestCat);
            e.addEventListener("touchend", l.mobileDragEndTestCat)
        }
        ;
        this.mobileDragMoveTestCat = function(t) {
            if (t.touches.length != 1)
                return;
            l.disableButtonClick = true;
            var n = FWDS3DCovUtils.getViewportMouseCoordinates(t);
            l.mouseX = n.screenX;
            l.mouseY = n.screenY;
            var r = Math.atan2(l.mouseY - l.lastPressedY, l.mouseX - l.lastPressedX);
            var i = Math.abs(r) * 180 / Math.PI;
            if (i > 120 || i < 60) {
                if (t.preventDefault)
                    t.preventDefault();
                var s = l.curX + (l.mouseX - l.lastPressedX);
                s = Math.min(s, 0);
                s = Math.max(s, l.getWidth() - l.totalWidth);
                FWDS3DCovModTweenMax.to(l.buttonsHolderDO, .2, {
                    x: Math.floor(s)
                })
            } else {
                e.removeEventListener("touchmove", l.mobileDragMoveTestCat)
            }
        }
        ;
        this.mobileDragEndTestCat = function(t) {
            l.disableThumbClick = false;
            e.removeEventListener("touchmove", l.mobileDragMoveTestCat);
            e.removeEventListener("touchend", l.mobileDragEndTestCat)
        }
        ;
        this.mobileDragStartHandlerCat = function(t) {
            ...
            l.lastPressedX = n.screenX;
            l.curX = l.buttonsHolderDO.getX();
            e.addEventListener("MSPointerUp", l.mobileDragEndHandlerCat, false);
            e.addEventListener("MSPointerMove", l.mobileDragMoveHandlerCat)
        }
        ;
        this.mobileDragMoveHandlerCat = function(e) {
            if (e.preventDefault)
                e.preventDefault();
            l.disableThumbClick = true;
            var t = FWDS3DCovUtils.getViewportMouseCoordinates(e);
            l.mouseX = t.screenX;
            var n = l.curX + (l.mouseX - l.lastPressedX);
            n = Math.max(n, 0);
            n = Math.min(n, l.getWidth() - l.totalWidth);
            FWDS3DCovModTweenMax.to(l.buttonsHolderDO, .2, {
                x: Math.floor(n)
            })
        }
        ...
        this.mobileDragEndHandlerCat = function(t) {
            l.disableThumbClick = false;
            e.removeEventListener("MSPointerUp", l.mobileDragEndHandlerCat);
            e.removeEventListener("MSPointerMove", l.mobileDragMoveHandlerCat)
        }
        ;
        this.destroy = function() {
            clearTimeout(l.positionButtonsId);
            FWDS3DCovModTweenMax.killTweensOf(l);
            FWDS3DCovModTweenMax.killTweensOf(l.buttonsHolderDO);
            for (var e = 0; e < l.totalItems; e++) {
                l.buttonsAr[e].destroy();
                l.buttonsAr[e] = null 
            }
            l.setInnerHTML("");
            c.destroy();
    ...
    t.setPrototype = function() {
        t.prototype = new FWDS3DCovDisplayObject3D("div")
    }
    ;
    t.CHANGE = "onChange";
    t.prototype = null ;
    e.FWDS3DCovCategoriesMenu = t
}
)(window);
(function(e) {
    var t = function(e, n, r, i, s, o) {
        ...
        this.onMouseOver = function(e) {
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                FWDS3DCovModTweenMax.killTweensOf(u.n1_do);
                FWDS3DCovModTweenMax.killTweensOf(u.n2_do);
                FWDS3DCovModTweenMax.to(u.n1_do, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                });
                FWDS3DCovModTweenMax.to(u.n2_do, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                })
            }
...
(function() {
    var e = function(e, t) {
        ...
        this.contextMenuWindowOnMouseDownHandler = function(e) {
            ...
            var r = t.screenX;
            var i = t.screenY;
            if (!FWDS3DCovUtils.hitTest(n.menu_do.screen, r, i)) {
        ...
        this.setupMenus = function() {
            ...
            this.normalMenu_do.setInnerHTML("&#0169; made by <a href='https://github.com/sanket-berde' target='_blank'>Sanket Berde</a>");
            ...
            this.selectedMenu_do.setInnerHTML("&#0169; made by <a href='https://github.com/sanket-berde' target='_blank'>Sanket Berde</a>");
        ...
        this.mouseOverHandler = function() {
            if (n.url.indexOf("w.we") == -1)
                n.menu_do.visible = false;
            FWDS3DCovModTweenMax.to(n.normalMenu_do, .8, {
                alpha: 0,
                ease: Expo.easeOut
            });
            FWDS3DCovModTweenMax.to(n.selectedMenu_do, .8, {
                alpha: 1,
                ease: Expo.easeOut
            })
        }
        ...
        this.destroy = function() {
            ...
            if (this.menu_do) {
                FWDS3DCovModTweenMax.killTweensOf(n.normalMenu_do);
                FWDS3DCovModTweenMax.killTweensOf(n.selectedMenu_do);
...
(function(e) {
    var t = function(e) {
        ...
        this.parseProperties = function() {
            var e;
            if (!n.propsObj.coverflowDataListDivId) {
                e = "Coverflow data list id is not defined in FWDSimple3DCoverflow constructor function!";
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: e
                });
                return
            }
            n.rootElement = FWDS3DCovUtils.getChildById(n.propsObj.coverflowDataListDivId);
            if (!n.rootElement) {
                e = "Make sure that the div with the id <font color='#FFFFFF'>" + n.propsObj.coverflowDataListDivId + "</font> exists, this represents the coverflow data list.";
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: e
                });
                return
            ...
            n.thumbXOffset3D = n.propsObj.thumbnailXOffset3D || 0;
            n.thumbXSpace3D = n.propsObj.thumbnailXSpace3D || 0;
            n.thumbZOffset3D = n.propsObj.thumbnailZOffset3D || 0;
            n.thumbZSpace3D = n.propsObj.thumbnailZSpace3D || 0;
            n.thumbYAngle3D = n.propsObj.thumbnailYAngle3D || 0;
            n.thumbXOffset2D = n.propsObj.thumbnailXOffset2D || 0;
            n.thumbXSpace2D = n.propsObj.thumbnailXSpace2D || 0;
            n.thumbHoverOffset = n.propsObj.thumbnailHoverOffset || 0;
            ...
            if (n.propsObj.numberOfThumbnailsToDisplayLeftAndRight == "all") {
                n.nrThumbsToDisplay = 0
            } else {
                n.nrThumbsToDisplay = n.propsObj.numberOfThumbnailsToDisplayLeftAndRight || 0
            }
            ...
            n.thumbsAlignment = n.propsObj.thumbnailsAlignment;
            n.showGradient = n.propsObj.showThumbnailsGradient == "yes" ? true : false;
            n.gradientColor1 = n.propsObj.thumbnailGradientColor1;
            n.gradientColor2 = n.propsObj.thumbnailGradientColor2;
            n.showText = n.propsObj.showText == "yes" ? true : false;
            n.textOffset = n.propsObj.textOffset || 10;
            n.showBoxShadow = n.propsObj.showThumbnailBoxShadow == "yes" ? true : false;
            n.thumbBoxShadowCss = n.propsObj.thumbnailBoxShadowCss;
            n.showTooltip = n.propsObj.showTooltip == "yes" ? true : false;
            n.dynTooltip = n.propsObj.dynamicTooltip == "yes" ? true : false;
            n.showDisplay2DAlways = n.propsObj.showDisplay2DAlways == "yes" ? true : false;
            n.coverflowStartPosition = n.propsObj.coverflowStartPosition;
            n.coverflowTopology = n.propsObj.coverflowTopology;
            n.coverflowXRotation = n.propsObj.coverflowXRotation;
            n.coverflowYRotation = n.propsObj.coverflowYRotation;
            n.rightClickContextMenu = n.propsObj.rightClickContextMenu;
            n.infiniteLoop = n.propsObj.infiniteLoop == "yes" ? true : false;
            ...
            n.controlsOffset = n.propsObj.controlsOffset || 15;
            n.showCategoriesMenu = n.propsObj.showCategoriesMenu == "yes" ? true : false;
            n.catMaxWidth = n.propsObj.categoriesMenuMaxWidth || 700;
            n.catOffset = n.propsObj.categoriesMenuOffset || 25;
            n.catColorNormal = n.propsObj.categoryColorNormal;
            n.catColorSelected = n.propsObj.categoryColorSelected;
            ...
            var r = FWDS3DCovUtils.getChildrenFromAttribute(n.rootElement, "data-cat");
            if (!r) {
            ...
            for (var g = 0; g < i; g++) {
                ...
                u = [];
                o = [];
                h = FWDS3DCovUtils.getChildren(f);
                l = h.length;
                for (var y = 0; y < l; y++) {
                    var b = {};
                    var w = h[y];
                    var a = FWDS3DCovUtils.getChildren(w);
                    v = g + 1;
                    m = y + 1;
                    c = a.length;
                    var E = true;
                    for (var S = 0; S < c; S++) {
                        d = "data-thumbnail-path";
                        if (FWDS3DCovUtils.hasAttribute(a[S], "data-thumbnail-path")) {
                            E = false;
                            b.thumbPath = FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(a[S], "data-thumbnail-path"));
                            p = a[S];
                            break
                        }
                    }
                    if (E) {
                        e = "Element with attribute <font color='#FFFFFF'>" + d + "</font> is not defined in the datalist number - <font color='#FFFFFF'>" + v + "</font> at position - <font color='#FFFFFF'>" + m + "</font> in the datalist ul element.";
                        n.dispatchEvent(t.LOAD_ERROR, {
                            text: e
                        });
                        return
                    }
                    if (FWDS3DCovUtils.hasAttribute(p, "data-thumbnail-width") && FWDS3DCovUtils.hasAttribute(p, "data-thumbnail-height")) {
                        b.thumbWidth = parseInt(FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(p, "data-thumbnail-width"))) + n.thumbBorderSize * 2;
                        b.thumbHeight = parseInt(FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(p, "data-thumbnail-height"))) + n.thumbBorderSize * 2
                    } else {
                        b.thumbWidth = n.thumbWidth;
                        b.thumbHeight = n.thumbHeight
                    }
                    if (n.showTooltip || n.showText) {
                        var E = true;
                        for (var S = 0; S < c; S++) {
                            d = "data-thumbnail-text";
                            if (FWDS3DCovUtils.hasAttribute(a[S], "data-thumbnail-text")) {
                                E = false;
                                b.thumbText = a[S].innerHTML;
                                p = a[S];
                                break
                            }
                        }
                    ...
                    for (var S = 0; S < c; S++) {
                        d = "data-type";
                        if (FWDS3DCovUtils.hasAttribute(a[S], "data-type")) {
                            E = false;
                            b.mediaType = FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(a[S], "data-type"));
                            break
                        }
                    }
                    if (E) {
                    ...
                    if (b.mediaType != "none") {
                        ...
                        for (var S = 0; S < c; S++) {
                            d = "data-url";
                            if (FWDS3DCovUtils.hasAttribute(a[S], "data-url")) {
                                E = false;
                                p = a[S];
                                break
                            }
                    ...
                    p = a[S];
                    var x = {};
                    x.dataType = FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(p, "data-type"));
                    x.url = FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(p, "data-url"));
                    x.target = FWDS3DCovUtils.getAttributeValue(p, "data-target");
                    x.info = FWDS3DCovUtils.getAttributeValue(p, "data-info");
                    if (!x.target)
                        x.target = "_blank";
                    for (var S = 0; S < c; S++) {
                        if (FWDS3DCovUtils.hasAttribute(a[S], "data-info")) {
                            x.infoText = a[S].innerHTML;
                            break
                        }
                    }
                    b.secondObj = x;
                    if (b.mediaType != "link" && b.mediaType != "none") {
                        o.push(x);
                        s.push(x)
                    }
                    u[y] = b
                }
                n.categoriesAr[g] = FWDS3DCovUtils.getAttributeValue(f, "data-cat") || "not defined!";
                n.dataListAr[g] = u;
                n.lightboxAr[g] = o
            }
            n.startAtCategory = n.propsObj.startAtCategory || 1;
            if (isNaN(n.startAtCategory))
                n.startAtCategory = 1;
            if (n.startAtCategory <= 0)
                n.startAtCategory = 1;
            if (n.startAtCategory > i)
                n.startAtCategory = i;
            n.startAtCategory -= 1;
            if (!n.propsObj.skinPath) {
                n.dispatchEvent(t.LOAD_ERROR, {
                    text: "Coverflow graphics skin path is not defined in FWDSimple3DCoverflow constructor function!"
                });
                return
            }
            n.preloaderPath = n.propsObj.skinPath + "/preloader.png";
            var T = n.propsObj.skinPath + "/nextButtonNormalState.png";
            var N = n.propsObj.skinPath + "/nextButtonSelectedState.png";
            var C = n.propsObj.skinPath + "/prevButtonNormalState.png";
            var k = n.propsObj.skinPath + "/prevButtonSelectedState.png";
            var L = n.propsObj.skinPath + "/playButtonNormalState.png";
            var A = n.propsObj.skinPath + "/playButtonSelectedState.png";
            var O = n.propsObj.skinPath + "/pauseButtonSelectedState.png";
            var M = n.propsObj.skinPath + "/handlerLeftNormal.png";
            var _ = n.propsObj.skinPath + "/handlerLeftSelected.png";
            ...
            var D = n.propsObj.skinPath + "/handlerRightNormal.png";
            var P = n.propsObj.skinPath + "/handlerRightSelected.png";
            var H = n.propsObj.skinPath + "/trackLeft.png";
            n.trackCenterPath = n.propsObj.skinPath + "/trackCenter.png";
            var B = n.propsObj.skinPath + "/trackRight.png";
            var j = n.propsObj.skinPath + "/slideshowTimer.png";
            var F = n.propsObj.skinPath + "/slideShowPreloader.png";
            var I = n.propsObj.skinPath + "/closeButtonNormalState.png";
            var q = n.propsObj.skinPath + "/closeButtonSelectedState.png";
            var R = n.propsObj.skinPath + "/lightboxNextButtonNormalState.png";
            var U = n.propsObj.skinPath + "/lightboxNextButtonSelectedState.png";
            var z = n.propsObj.skinPath + "/lightboxPrevButtonNormalState.png";
            var W = n.propsObj.skinPath + "/lightboxPrevButtonSelectedState.png";
            var X = n.propsObj.skinPath + "/lightboxPlayButtonNormalState.png";
            var V = n.propsObj.skinPath + "/lightboxPlayButtonSelectedState.png";
            var $ = n.propsObj.skinPath + "/lightboxPauseButtonNormalState.png";
            var J = n.propsObj.skinPath + "/lightboxPauseButtonSelectedState.png";
            var K = n.propsObj.skinPath + "/maximizeButtonNormalState.png";
            var Q = n.propsObj.skinPath + "/maximizeButtonSelectedState.png";
            var G = n.propsObj.skinPath + "/minimizeButtonNormalState.png";
            var Y = n.propsObj.skinPath + "/minimizeButtonSelectedState.png";
            var Z = n.propsObj.skinPath + "/infoButtonOpenNormalState.png";
            var et = n.propsObj.skinPath + "/infoButtonOpenSelectedState.png";
            var tt = n.propsObj.skinPath + "/infoButtonCloseNormalPath.png";
            var nt = n.propsObj.skinPath + "/infoButtonCloseSelectedPath.png";
            n.graphicsPathsAr.push(T);
        ...
        this.checkForAttribute = function(e, r) {
            var i = FWDS3DCovUtils.getChildFromNodeListFromAttribute(e, r);
            i = i ? FWDS3DCovUtils.trim(FWDS3DCovUtils.getAttributeValue(i, r)) : undefined;
            if (!i) {
                n.dispatchEvent(t.LOAD_ERROR, {
        ...
        this.destroy = function() {
            ...
            if (this.mainPreloaderImg)
                this.mainPreloaderImg.src = "";
            if (this.thumbTitleGradientImg)
                this.thumbTitleGradientImg.src = "";
            if (this.nextButtonNImg)
                this.nextButtonNImg.src = "";
            if (this.nextButtonSImg)
                this.nextButtonSImg.src = "";
            if (this.prevButtonNImg)
                this.prevButtonNImg.src = "";
            if (this.prevButtonSImg)
                this.prevButtonSImg.src = "";
            if (this.playButtonNImg)
                this.playButtonNImg.src = "";
            if (this.playButtonSImg)
                this.playButtonSImg.src = "";
            if (this.pauseButtonNImg)
                this.pauseButtonNImg.src = "";
            if (this.pauseButtonSImg)
                this.pauseButtonSImg.src = "";
            if (this.handlerLeftNImg)
                this.handlerLeftNImg.src = "";
            if (this.handlerLeftSImg)
                this.handlerLeftSImg.src = "";
            if (this.handlerCenterNImg)
                this.handlerCenterNImg.src = "";
            if (this.handlerCenterSImg)
                this.handlerCenterSImg.src = "";
            if (this.handlerRightNImg)
                this.handlerRightNImg.src = "";
            if (this.handlerRightSImg)
                this.handlerRightSImg.src = "";
            if (this.trackLeftImg)
                this.trackLeftImg.src = "";
            if (this.trackCenterImg)
                this.trackCenterImg.src = "";
            if (this.trackRightImg)
                this.trackRightImg.src = "";
            if (this.slideshowTimerImg)
                this.slideshowTimerImg.src = "";
            ...
            if (this.lightboxCloseButtonN_img)
                this.lightboxCloseButtonN_img.src = "";
            if (this.lightboxCloseButtonS_img)
                this.lightboxCloseButtonS_img.src = "";
            if (this.lightboxNextButtonN_img)
                this.lightboxNextButtonN_img.src = "";
            if (this.lightboxNextButtonS_img)
                this.lightboxNextButtonS_img.src = "";
            if (this.lightboxPrevButtonN_img)
                this.lightboxPrevButtonN_img.src = "";
            if (this.lightboxPrevButtonS_img)
                this.lightboxPrevButtonS_img.src = "";
            if (this.lightboxPlayN_img)
                this.lightboxPlayN_img.src = "";
            if (this.lightboxPlayS_img)
                this.lightboxPlayS_img.src = "";
            if (this.lightboxPauseN_img)
                this.lightboxPauseN_img.src = "";
            if (this.lightboxPauseS_img)
                this.lightboxPauseS_img.src = "";
            if (this.lightboxMaximizeN_img)
                this.lightboxMaximizeN_img.src = "";
            if (this.lightboxMaximizeS_img)
                this.lightboxMaximizeS_img.src = "";
            if (this.lightboxMinimizeN_img)
                this.lightboxMinimizeN_img.src = "";
            if (this.lightboxMinimizeS_img)
                this.lightboxMinimizeS_img.src = "";
            if (this.lightboxInfoOpenN_img)
                this.lightboxInfoOpenN_img.src = "";
            if (this.lightboxInfoOpenS_img)
                this.lightboxInfoOpenS_img.src = "";
            if (this.lightboxInfoCloseN_img)
                this.lightboxInfoCloseN_img.src = "";
            if (this.lightboxInfoCloseS_img)
                this.lightboxInfoCloseS_img.src = "";
    ...
    ;
    t.setPrototype = function() {
        t.prototype = new FWDS3DCovEventDispatcher
    }
    ;
    t.prototype = null ;
    ...
    var t = function(e, t, n, r) {
        ...
        this.setMainProperties = function() {
            ...
            if (this.opacityType == "opacity")
                this.isHtml5_bl = true;
            if (i.opacityType == "filter")
                i.screen.style.filter = "inherit";
        ...
        this.setY = function(e) {
            ...
            if (i.isMobile_bl) {
                i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px)"
            } else if (i.hasTransform3d_bl && !FWDS3DCovUtils.isAndroid) {
                i.screen.style[i.transform] = "translate3d(" + i.x + "px," + i.y + "px,0)"
            } else if (i.hasTransform2d_bl) {
                i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y + "px)"
            } else {
        ...
        this.getHeight = function() {
            if (i.type == "div") {
                if (i.screen.offsetHeight != 0)
                    return i.screen.offsetHeight;
                return i.h
            } else if (i.type == "img") {
                if (i.screen.offsetHeight != 0)
                    return i.screen.offsetHeight;
                if (i.screen.height != 0)
...
(function() {
    ...
    ;
    window.FWDS3DCovEventDispatcher = e
}
)(window);
(function(e) {
    var t = function() {
    ...
    ;
    t.setPrototype = function() {
        t.prototype = new FWDS3DCovDisplayObject("div","relative")
    }
    ;
    t.prototype = null ;
    e.FWDS3DCovInfo = t
...
(function(e) {
    var t = function(n, r, i, s, o) {
        ...
        this.resize = function(e, t, n) {
            ...
            FWDS3DCovModTweenMax.killTweensOf(u.obj);
            if (n) {
                FWDS3DCovModTweenMax.to(u.obj, .8, {
                    delay: .1,
        ...
        this.hide = function(e) {
            ...
            if (e) {
                FWDS3DCovModTweenMax.to(this, .6, {
                    y: -this.finalHeight,
                    ease: Expo.easeInOut,
...
(function(e) {
    var t = function(n) {
        ...
        this.init = function() {
            ...
            if (this.infoButton_do)
                this.buttons_ar.push(this.infoButton_do);
            if (this.showSlideshowButton_bl)
                this.buttons_ar.push(this.slideshowButtton_do);
            if (this.zoomButton_do)
                this.buttons_ar.push(this.zoomButton_do);
            if (this.showNextAndPrevButtons_bl)
                this.buttons_ar.push(this.nextButton_do)
        }
        ;
        ...
        r.onScrollHandler = function(e) {
            if (!r.orintationChanceComplete_bl)
                return;
            var t = FWDS3DCovUtils.getScrollOffsets();
            r.setX(t.x);
            r.setY(t.y)
        }
        ;
        ...
        this.resizeHandler = function() {
            ...
            var t = FWDS3DCovUtils.getScrollOffsets();
            if (r.stageWidth == e.w && r.stageHeight == e.h)
                return;
            ...
            if (r.infoWindow_do && r.infoWindow_do.isShowed_bl)
                r.infoWindow_do.resize(r.finalWidth, r.finalHeight, false)
        }
        ;
        ...
        this.setupBackgorundAndMainItemHolder = function() {
            ...
            this.itemsBorder_do.setCSSGradient("top", r.borderColor_str1, r.borderColor_str2);
        ...
        this.show = function(e) {
            ...
            FWDS3DCovModTweenMax.to(this.bk_do, .8, {
        ...
        this.createItem = function() {
            ...
            if (this.contains(this.info_do))
                this.removeChild(this.info_do);
            if (this.image_img) {
            ...
            if (this.infoButton_do)
                this.infoButton_do.isDisabled_bl = true;
                ...
                if (this.firstTimeShowed_bl) {
                    ...
                    if (this.prevItem_do) {
                        if (this.opacityType == "filter" && this.prevItem_do.type != "img") {
                            ...
                            FWDS3DCovModTweenMax.to(this.prevItem_do, .8, {
                                alpha: 0
                            })
                        }
                    }
                    ...
                    if (this.showZoomButton_bl && (this.type_str == t.YOUTUBE || this.type_str == t.VIMEO || r.type_str == t.IFRAME)) {
                        var e = FWDS3DCovUtils.indexOfArray(this.buttons_ar, this.zoomButton_do);
                        if (e != -1) {
        ...
        this.imageLoadComplete = function(e) {
            if (r.prevItem_do) {
                if (!r.isMobile_bl && r.prevItem_do.type == "img")
                    FWDS3DCovModTweenMax.to(r.prevItem_do, .6, {
                        alpha: 0
                    })
            }
            r.originalWidth = r.image_img.width;
            r.originalHeight = r.image_img.height;
            r.currentItem_do = new FWDS3DCovDisplayObject("img");
            r.currentItem_do.setScreen(r.image_img);
            if (r.borderRadius != 0)
                r.currentItem_do.getStyle().borderRadius = r.borderRadius + "px";
            if (r.borderRadius != 0)
                r.itemsBorder_do.getStyle().borderRadius = r.borderRadius + "px";
            if (r.borderRadius != 0)
                r.itemsBackground_do.getStyle().borderRadius = r.borderRadius + "px";
            if (r.firstTimeShowed_bl) {
                ...
                FWDS3DCovModTweenMax.to(r.currentItem_do, .6, {
                    alpha: 1,
                    delay: .8
                });
        ...
        this.transitionShapeDoneHandler = function() {
            if (r.infoButton_do)
                r.infoButton_do.isDisabled_bl = false
        }
        ;
        ...
        this.animMainDos = function() {
            FWDS3DCovModTweenMax.to(this.mainItemsHolder_do, .8, {
                delay: .1,
                x: r.finalX,
                y: r.finalY,
                w: r.finalWidth,
            ...
            FWDS3DCovModTweenMax.to(this.itemsBackground_do, .8, {
                delay: .1,
                x: r.borderSize,
                y: r.borderSize,
            ...
            FWDS3DCovModTweenMax.to(this.itemsBorder_do, .8, {
                delay: .1,
                w: r.finalWidth,
                h: r.finalHeight,
                ease: Expo.easeInOut
            });
            FWDS3DCovModTweenMax.to(this.itemsHolder_do, .8, {
                delay: .1,
                x: r.borderSize,
                y: r.borderSize,
                w: r.finalWidth - r.borderSize * 2,
            ...
            if (!this.isMobile_bl && this.prevItem_do.type == "img")
                FWDS3DCovModTweenMax.to(r.prevItem_do, .8, {
                    delay: .1,
        ...
        this.showItemFirstTime = function() {
            ...
            if (this.showInfoWindowByDefault_bl)
                this.showInfoWindowOnStart();
            FWDS3DCovModTweenMax.to(this.currentItem_do, .8, {
                alpha: 1,
                delay: .9,
                ease: Quint.easeOut
            });
        ...
        this.cleanChildren = function(e) {
            ...
            while (r.itemsHolder_do.getNumChildren() > e) {
                ...
                FWDS3DCovModTweenMax.killTweensOf(t);
                r.itemsHolder_do.removeChild(t);
                if (r.opacityType == "opacity" && t.type != "img")
                    t.setInnerHTML("");
                t.destroy()
            }
            t = null 
        ...
        this.maximizeOrMinimize = function() {
            if (this.isLoading_bl || r.isTweeningOnShowOrHide_bl)
                return;
            ...
            if (this.isMaximized_bl) {
                ...
                this.isTweening_bl = true;
                if (r.borderRadius != 0)
                    r.currentItem_do.getStyle().borderRadius = "";
                ...
                if (this.isMobile_bl) {
                    FWDS3DCovModTweenMax.to(this.zoomButton_do, .8, {
                ...
                if (r.infoWindow_do)
                    if (r.infoButton_do.currentState == 0)
                        this.infoWindow_do.hide(false);
        ...
        this.maximizeCompleteHandler = function() {
            ...
            if (r.isMobile_bl)
                r.addEventsForScrollngImageOnMobile()
        }
        ;
        this.minimizeCompleteHandler = function() {
            if (r.infoWindow_do)
                if (r.infoButton_do.currentState == 0)
                    r.infoWindow_do.show(true);
            if (r.showSlideshowButton_bl)
                r.timerManager.start();
        ...
        this.updateMaximizeImageOnMouseMovedHandler = function(e) {
            var t = FWDS3DCovUtils.getViewportMouseCoordinates(e);
            var n = FWDS3DCovUtils.getScrollOffsets();
            r.globalXMousePosition = t.screenX;
            r.globalYMousePosition = t.screenY;
            FWDS3DCovModTweenMax.to(r.zoomButton_do, .2, {
        ...
        this.updateMaximizedImageHandler = function() {
            ...
            if (n <= i) {
                ...
                if (isNaN(e))
                    return;
                FWDS3DCovModTweenMax.to(r.currentItem_do, .4, {
                    x: e
                })
            } else {
        ...
        this.showInfoWindowOnStart = function() {
            if (!r.infoWindow_do)
                return;
            if (this.infoButton_do)
                this.infoButton_do.setSecondButtonState();
            r.infoWindow_do.setText(r.data_ar[r.id].infoText, r.finalWidth, r.finalHeight, false, r.type_str != t.IMAGE);
            if (!r.mainItemsHolder_do.contains(r.infoWindow_do))
                r.mainItemsHolder_do.addChild(r.infoWindow_do)
        }
        ;
        ...
        this.onTimerManagerStartHandler = function() {
            if (!r.timerManager.isStopped_bl)
                r.slideShowPreloader_do.animIn()
        }
        ;
        ...
        this.positionSlideShowPreloader = function(e) {
            ...
            if (e) {
                FWDS3DCovModTweenMax.to(this.slideShowPreloader_do, .8, {
        ...
        this.positionButtons = function(e) {
            ...
            for (var u = 0; u < n; u++) {
                ...
                if (t == this.nextButton_do) {
                    ...
                    if (t.finalY < this.buttons_ar[u - 1].finalY + this.buttonHeight + 1)
            ...
            if (this.showNextAndPrevButtons_bl) {
                ...
                if (e) {
                    FWDS3DCovModTweenMax.to(this.prevButton_do, .8, {
        ...
        this.hide = function() {
            ...
            if (this.type_str == t.YOUTUBE || this.type_str == t.VIMEO || r.type_str == t.IFRAME) {
                ...
                FWDS3DCovModTweenMax.to(this.itemsBorder_do, .9, {
                    alpha: 0,
                    ease: Quint.easeOut
                });
                FWDS3DCovModTweenMax.to(this.mainItemsHolder_do, .9, {
                    x: this.stageWidth / 2,
                ...
                FWDS3DCovModTweenMax.to(this.bk_do, .9, {
                    alpha: 0,
                    delay: .9,
                    ease: Quint.easeOut,
                ...
                if (this.currentItem_do && this.currentItem_do.screen) {
                    FWDS3DCovModTweenMax.killTweensOf(this.currentItem_do);
                    FWDS3DCovModTweenMax.to(this.currentItem_do, .7, {
                        alpha: 0,
                        ease: Quint.easeOut
                    })
                }
        ...
        this.hideButtons = function(e) {
            if (e) {
                FWDS3DCovModTweenMax.to(this.closeButton_do, .8, {
                    x: this.stageWidth,
                    ease: Expo.easeInOut
                });
                if (this.infoButton_do)
                    FWDS3DCovModTweenMax.to(this.infoButton_do, .8, {
                        x: this.stageWidth,
                        ease: Expo.easeInOut
                    });
                if (this.slideshowButtton_do)
                    FWDS3DCovModTweenMax.to(this.slideshowButtton_do, .8, {
                        x: this.stageWidth,
                        ease: Expo.easeInOut
                    });
                if (this.zoomButton_do)
                ...
                if (this.nextButton_do) {
                    FWDS3DCovModTweenMax.to(this.nextButton_do, .8, {
                        x: this.stageWidth,
                        ease: Expo.easeInOut
                    });
                    FWDS3DCovModTweenMax.to(this.prevButton_do, .8, {
                ...
                if (this.infoButton_do)
                    this.infoButton_do.setVisible(false);
                if (this.zoomButton_do)
                    this.zoomButton_do.setVisible(false);
                if (this.slideshowButtton_do)
                ...
                if (this.slideShowPreloader_do)
                    this.slideShowPreloader_do.image_do.setVisible(false)
            }
        }
        ;
        ...
        this.destroy = function() {
            ...
            if (this.infoWindow_do)
                this.infoWindow_do.destroy();
            if (this.timerManager)
                this.timerManager.destroy();
            this.preloader_do.destroy();
            if (this.customContextMenu)
                this.customContextMenu.destroy();
            this.clearMainEventsIntervalsAndTimeOuts();
            this.cleanChildren(0);
            if (this.nextButton_do) {
    ...
    t.prototype = null ;
    e.FWDS3DCovLightBox = t
}
)(window);
(window._gsQueue || (window._gsQueue = [])).push(function() {
    "use strict";
    window._gsDefine("FWDS3DCovModTweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(e, t, n) {
        var r = [].slice
          , i = function(e, t, r) {
            n.call(this, e, t, r);
            this._cycle = 0;
    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(e, t) {
        ...
        , S = /(?:Left|Right|Width)/i, x = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, T = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, N = /,(?=[^\)]*(?:\(|$))/gi, C = Math.PI / 180, k = 180 / Math.PI, L = {}, A = document, O = A.createElement("div"), M = A.createElement("img"), _ = n._internals = {
            _specialProps: u
        }, D = navigator.userAgent, P, H, B, j, F, I, q = function() {
        ...
        var wt = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(",")
          ...
          , Nt = function(e, t, r) {
            var i = r ? e._gsTransform || {
                ...
                skewY: 0
            }, s = i.scaleX < 0, o = 2e-5, u = 1e5, a = -Math.PI + 1e-4, f = Math.PI - 1e-4, l = Tt ? parseFloat($(e, xt, t, false, "0 0 0").split(" ")[2]) || i.zOrigin || 0 : 0, c, h, p, d, v, m, g, y, b, w, E, S, T;
            if (Et) {
                c = $(e, St, t, true)
            } else if (e.currentStyle) {
...
(function(e) {
    var t = function(e, n, r, i, s) {
        ...
        this.show = function() {
            o.setVisible(true);
            o.start();
            FWDS3DCovModTweenMax.killTweensOf(o);
            o.setAlpha(0);
...
(function(e) {
    var t = function(n, r, i) {
        ...
        this.setTrack = function() {
            ...
            s.scrollbarTrackRightDO = new FWDS3DCovSimpleDisplayObject("img");
        ...
        this.setHandler = function() {
            s.scrollbarHandlerDO = new FWDS3DCovDisplayObject("div");
            ...
            s.scrollbarHandlerCenterNDO = new FWDS3DCovSimpleDisplayObject("div");
            ...
            s.scrollbarHandlerRightSDO = new FWDS3DCovSimpleDisplayObject("img");
            ...
            s.scrollbarHandlerRightNDO = new FWDS3DCovSimpleDisplayObject("img");
            ...
            s.scrollbarHandlerTextDO = new FWDS3DCovDisplayObject("div");
            ...
            s.scrollbarHandlerOverDO = new FWDS3DCovDisplayObject("div");
        ...
        this.onScrollMouseOver = function() {
            ...
            FWDS3DCovModTweenMax.to(s.scrollbarHandlerLeftNDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            });
            FWDS3DCovModTweenMax.to(s.scrollbarHandlerCenterNDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            });
            FWDS3DCovModTweenMax.to(s.scrollbarHandlerRightNDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            });
            FWDS3DCovModTweenMax.to(s.scrollbarHandlerTextDO.screen, .8, {
                css: {
        ...
        this.onScrollMouseDown = function(t) {
            ...
            s.isPressed = true;
            FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerDO);
            if (s.isMobile) {
                if (s.hasPointerEvent) {
                ...
                if (s.screen.addEventListener)
                    e.addEventListener("mousemove", s.onScrollMove);
                else
                    document.attachEvent("onmousemove", s.onScrollMove)
            }
        }
        ;
        this.onScrollMove = function(e) {
            var n = FWDS3DCovUtils.getViewportMouseCoordinates(e);
            s.mouseX = n.screenX;
            s.mouseY = n.screenY;
        ...
        this.onScrollMouseUp = function() {
            ...
            if (s.isMobile) {
                ...
                if (s.screen.addEventListener)
                    e.removeEventListener("mousemove", s.onScrollMove);
                else
                    document.detachEvent("onmousemove", s.onScrollMove)
            }
            if (!s.scrollbarOver && !s.isMobile)
                s.onScrollMouseOut();
            s.gotoItem2()
        }
        ;
        this.gotoItem = function(e, t) {
            ...
            if (s.prevCurItemId != s.curItemId) {
                if (t) {
                    FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerDO);
                    FWDS3DCovModTweenMax.to(s.scrollbarHandlerDO, .8, {
        ...
        this.destroy = function() {
            ...
            FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerLeftNDO);
            FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerCenterNDO);
            FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerRightNDO);
            FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerDO);
            FWDS3DCovModTweenMax.killTweensOf(s.scrollbarHandlerTextDO.screen);
...
(function(e) {
    var t = function(e, n) {
        ...
        this.onMouseOver = function(e) {
            if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
                FWDS3DCovModTweenMax.to(r.n_do, .9, {
                    alpha: 0,
                    ease: Expo.easeOut
                })
            }
        ...
        this.destroy = function() {
            ...
            FWDS3DCovModTweenMax.killTweensOf(r.n_do);
            r.n_do.destroy();
            r.s_do.destroy();
            r.nImg = null ;
            r.sImg = null ;
...
(function(e) {
    var t = function(e, t, n, r) {
        ...
        ;
        this.setCSSGradient = function(e, t, n) {
            if (FWDS3DCovUtils.isIEAndLessThen10) {
                i.setBkColor(t)
            } else {
                i.screen.style.backgroundImage = "-webkit-linear-gradient(" + e + ", " + t + ", " + n + ")";
                i.screen.style.backgroundImage = "-moz-linear-gradient(" + e + ", " + t + ", " + n + ")";
                i.screen.style.backgroundImage = "-ms-linear-gradient(" + e + ", " + t + ", " + n + ")";
                i.screen.style.backgroundImage = "-o-linear-gradient(" + e + ", " + t + ", " + n + ")"
            }
        }
        ;
    ...
    ;
    e.FWDS3DCovSimpleDisplayObject = t
}
)(window);
(function(e) {
    var t = function(n) {
        ...
        this.settimerButton = function() {
            ...
            if (r.curSeconds < 10)
                r.timerButtonTextDO.setInnerHTML("0" + r.curSeconds);
            else
                r.timerButtonTextDO.setInnerHTML(r.curSeconds);
        ...
        this.setPauseButton = function() {
            r.pauseButtonDO = new FWDS3DCovSimpleDisplayObject("img");
        ...
        this.setPlayButton = function() {
            r.playButtonDO = new FWDS3DCovDisplayObject("div");
            r.addChild(r.playButtonDO);
            r.playButtonSDO = new FWDS3DCovSimpleDisplayObject("img");
            r.playButtonSDO.setScreen(r.playButtonSImg);
            r.playButtonDO.addChild(r.playButtonSDO);
            r.playButtonNDO = new FWDS3DCovSimpleDisplayObject("img");
        ...
        this.onMouseOver = function() {
            if (r.isPlaying) {
                FWDS3DCovModTweenMax.to(r.timerButtonDO, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                })
            } else {
                FWDS3DCovModTweenMax.to(r.playButtonNDO, .8, {
                    alpha: 0,
                    ease: Expo.easeOut
                })
            }
        ...
        this.destroy = function() {
            ...
            FWDS3DCovModTweenMax.killTweensOf(r.timerButtonDO);
            FWDS3DCovModTweenMax.killTweensOf(r.playButtonNDO);
...
(function(e) {
    var t = function(e, n, r, i, s) {
        ...
        this.animIn = function() {
            ...
            this.currentPos = 0;
            FWDS3DCovModTweenMax.to(this.tweenObj, this.duration, {
                currentPos: 1,
        ...
        this.animOut = function() {
            FWDS3DCovModTweenMax.killTweensOf(this.tweenObj);
            FWDS3DCovModTweenMax.to(this.tweenObj, .8, {
                currentPos: 0,
                onUpdate: this.onUpdateHandler
            })
        }
        ...
        this.show = function() {
            ...
            if (this.opacityType == "opacity") {
                ...
                FWDS3DCovModTweenMax.to(this.image_do, 1, {
                    alpha: 1
                })
            } else {
                this.setWidth(this.segmentWidth)
    ...
    ;
    t.prototype = null ;
    e.FWDS3DCovSlideShowPreloader = t
}
)(window);
(function(e) {
    var t = function(e, n, r) {
        ...
        this.textDO = null ;
        this.tooltipDO = null ;
        this.curDataListAr = r.curDataListAr;
        this.thumbWidth = i.curDataListAr[i.id].thumbWidth;
        this.thumbHeight = i.curDataListAr[i.id].thumbHeight;
        this.mouseX = 0;
        this.mouseY = 0;
        this.gradPos = 0;
        this.thumbScale = 1;
        ...
        this.setupScreen = function() {
            if (FWDS3DCovUtils.isIOS) {
                i.mainDO = new FWDS3DCovDisplayObject3D("div","absolute","visible");
                i.addChild(i.mainDO);
                i.mainDO.setZ(1)
            } else {
                i.mainDO = new FWDS3DCovDisplayObject("div","absolute","visible");
                i.addChild(i.mainDO)
            }
            ...
            if (!n.transparentImages) {
                i.borderDO = new FWDS3DCovSimpleDisplayObject("div");
                i.bgDO = new FWDS3DCovSimpleDisplayObject("div");
                ...
                i.borderDO.setCSSGradient("top", i.borderColor1, i.borderColor2);
            ...
            i.imageHolderDO = new FWDS3DCovDisplayObject("div");
            ...
            if (i.isMobile) {
                ...
                if (i.screen.addEventListener) {
                    ...
                    i.mainDO.screen.addEventListener("mouseover", i.onMouseOverHandler);
                    i.mainDO.screen.addEventListener("mouseout", i.onMouseOutHandler)
                } else {
            ...
            if (!FWDS3DCovUtils.isIEAndLessThen10) {
                i.setTransformOrigin("100%")
            }
        }
        ;
        this.setTransformOrigin = function(e) {
            i.screen.style.transformOrigin = "50% " + e;
            i.screen.style.WebkitTransformOrigin = "50% " + e;
            i.screen.style.MozTransformOrigin = "50% " + e;
            i.screen.style.OTransformOrigin = "50% " + e;
            i.screen.style.msTransformOrigin = "50% " + e
        }
        ;
        this.setupTooltip = function() {
            FWDS3DCovTooltip.setPrototype();
            i.tooltipDO = new FWDS3DCovTooltip({
                skinPath: n.propsObj.skinPath + "/tooltip-skin",
                tooltipMaxWidth: 300,
                text: i.curDataListAr[i.id].thumbText,
                btnMode: true
            });
            r.parent.mainDO.addChild(i.tooltipDO);
            i.tooltipDO.screen.style.zIndex = 1e4;
            i.tooltipDO.setAlpha(0);
            i.tooltipDO.setX(-2e3)
        }
        ;
        this.addReflection = function() {
            if (!i.imageDO || i.isMobile || FWDS3DCovUtils.isIEAndLessThen9)
                return;
            var e = i.thumbWidth - i.borderSize * 2;
            var t = i.thumbHeight - i.borderSize * 2;
            i.reflCanvasDO = new FWDS3DCovSimpleDisplayObject("canvas");
            i.mainDO.addChild(i.reflCanvasDO);
        ...
        this.addImage = function(e) {
            i.imageDO = new FWDS3DCovSimpleDisplayObject("img");
        ...
        this.setupGradient = function() {
            if (i.isMobile || FWDS3DCovUtils.isIEAndLessThen10 || !r.showGradient)
                return;
            i.gradientDO = new FWDS3DCovDisplayObject("div");
            i.mainDO.addChild(i.gradientDO);
            i.gradientDO.setWidth(i.thumbWidth);
            if (r.showRefl && !i.isMobile && !FWDS3DCovUtils.isIEAndLessThen10) {
                i.gradientDO.setHeight(i.thumbHeight + r.reflDist + r.reflHeight)
            } else {
                i.gradientDO.setHeight(i.thumbHeight)
            }
            i.gradientLeftDO = new FWDS3DCovSimpleDisplayObject("div");
            i.gradientDO.addChild(i.gradientLeftDO);
            i.gradientLeftDO.setWidth(i.thumbWidth);
            if (r.showRefl && !i.isMobile && !FWDS3DCovUtils.isIEAndLessThen10) {
                i.gradientLeftDO.setHeight(i.thumbHeight + r.reflDist + r.reflHeight)
            } else {
                i.gradientLeftDO.setHeight(i.thumbHeight)
            }
            i.gradientLeftDO.setCSSGradient("left", r.gradientColor1, r.gradientColor2);
            i.gradientRightDO = new FWDS3DCovSimpleDisplayObject("div");
            i.gradientDO.addChild(i.gradientRightDO);
            i.gradientRightDO.setWidth(i.thumbWidth);
            if (r.showRefl && !i.isMobile && !FWDS3DCovUtils.isIEAndLessThen10) {
                i.gradientRightDO.setHeight(i.thumbHeight + r.reflDist + r.reflHeight)
            } else {
                i.gradientRightDO.setHeight(i.thumbHeight)
            }
            if (r.topology == "onesided" || r.topology == "frontonesided") {
                i.gradientRightDO.setCSSGradient("left", r.gradientColor1, r.gradientColor2)
            } else {
                i.gradientRightDO.setCSSGradient("left", r.gradientColor2, r.gradientColor1)
            }
        ...
        this.setGradient = function(e) {
            ...
            if (!i.isMobile && !FWDS3DCovUtils.isIEAndLessThen10 && r.showGradient) {
                switch (i.gradPos) {
                case 0:
                    FWDS3DCovModTweenMax.to(i.gradientLeftDO, .8, {
                        alpha: 0
                    });
                    FWDS3DCovModTweenMax.to(i.gradientRightDO, .8, {
                        alpha: 0,
                        onComplete: i.hideGrad
                    });
                    break;
                case 1:
                    i.gradientDO.setY(0);
        ...
        this.onThumbOverHandler = function(e) {
            if (!i.isOver) {
                i.isOver = true;
                if (FWDS3DCovUtils.isIEAndLessThen9) {
                    i.tooltipDO.setAlpha(1)
                } else {
                    FWDS3DCovModTweenMax.to(i.tooltipDO, .4, {
                        alpha: 1,
                        ease: Expo.easeOut
                    })
                }
            ...
            var t = FWDS3DCovUtils.getViewportMouseCoordinates(e);
            var n = r.parent.rect.left;
            var s = r.parent.rect.top;
            if (r.dynTooltip) {
                newX = t.screenX - n;
                newY = t.screenY - s - 2;
                var o = 0;
                var u = i.tooltipDO.getTooltipWidth() / 2;
                var a = i.tooltipDO.getTooltipHeight();
                var f = false;
                if (newX > r.stageWidth - u) {
                    o = newX - r.stageWidth + u;
                    newX = r.stageWidth - u
                }
                if (newX < u) {
                    o = newX - u;
                ...
                i.tooltipDO.setPointerDX(o);
                i.tooltipDO.swapTooltip(f);
                newX = Math.floor(newX);
                newY = Math.floor(newY);
                i.tooltipDO.setX(newX);
                i.tooltipDO.setY(newY)
            } else {
                newX = r.stageWidth / 2;
                newY = r.stageHeight / 2 - i.thumbHeight / 2 - 5 + (i.getY() + i.thumbHeight / 2);
                var o = 0;
                var u = i.tooltipDO.getTooltipWidth() / 2;
                if (newX > r.stageWidth - u) {
                    o = newX - r.stageWidth + u;
        ...
        this.showThumb3D = function() {
            ...
            FWDS3DCovModTweenMax.to(i.imageHolderDO, .8, {
                x: i.borderSize,
                y: i.borderSize,
                w: e,
                h: t,
            ...
            FWDS3DCovModTweenMax.to(i.imageDO, .8, {
                x: 0,
                y: 0,
                ease: Expo.easeInOut
            });
            if (i.reflCanvasDO) {
                ...
                FWDS3DCovModTweenMax.to(i.reflCanvasDO, .8, {
                    alpha: 1,
                    ease: Expo.easeInOut
                })
            }
        ...
        this.showThumb2D = function() {
            if (!FWDS3DCovUtils.hasTransform2d) {
                ...
                var n = Math.floor(i.borderSize * i.thumbScale);
                if (i.borderSize > 0 && n < 1) {
                    n = 1
                }
                var r = e - n * 2;
                var s = t - n * 2;
                ...
                if (i.imageDO) {
                    i.imageDO.setWidth(r);
                    i.imageDO.setHeight(s);
                    i.imageDO.setX(-parseInt(r / 2));
                    i.imageDO.setY(-parseInt(s / 2));
                    FWDS3DCovModTweenMax.to(i.imageDO, .8, {
                        x: 0,
                        y: 0,
                        ease: Expo.easeInOut
                ...
                var r = i.thumbWidth - i.borderSize * 2;
                var s = i.thumbHeight - i.borderSize * 2;
                i.imageHolderDO.setX(parseInt(i.thumbWidth / 2));
                i.imageHolderDO.setY(parseInt(i.thumbHeight / 2));
                i.imageHolderDO.setWidth(0);
                i.imageHolderDO.setHeight(0);
        ...
        this.showThumbIntro2D = function(e, t) {
            i.thumbScale = e;
            if (!FWDS3DCovUtils.hasTransform2d) {
                var s = Math.floor(i.thumbWidth * e);
                var o = Math.floor(i.thumbHeight * e);
                var u = Math.floor(i.borderSize * e);
                if (i.borderSize > 0 && u < 1) {
                    u = 1
                }
                var a = s - u * 2;
                var f = o - u * 2;
                ...
                i.setHeight(o);
                i.mainDO.setWidth(s);
                i.mainDO.setHeight(o);
                if (i.borderDO) {
                    i.borderDO.setWidth(s);
                    i.borderDO.setHeight(o)
                }
                if (i.bgDO) {
                    i.bgDO.setX(u);
                    i.bgDO.setY(u);
                ...
                if (n.thumbsAlignment == "bottom") {
                    FWDS3DCovModTweenMax.to(i, .8, {
                        x: Math.floor(i.newX + (i.thumbWidth - s) / 2),
                        y: (-Math.floor(r.thumbsMaxHeight / 2) + (r.thumbsMaxHeight - i.thumbHeight)) * e,
                        ease: Expo.easeOut
                    })
                } else if (n.thumbsAlignment == "top") {
                    FWDS3DCovModTweenMax.to(i, .8, {
                        x: Math.floor(i.newX + (i.thumbWidth - s) / 2),
                        y: -Math.floor(r.thumbsMaxHeight / 2) * e,
                        ease: Expo.easeOut
                    })
                } else {
                    FWDS3DCovModTweenMax.to(i, .8, {
        ...
        this.setScale = function(e, t) {
            ...
            if (!FWDS3DCovUtils.hasTransform2d) {
                ...
                if (i.borderDO) {
                    FWDS3DCovModTweenMax.to(i.borderDO, .8, {
                        w: s,
                        h: o,
                        ease: Quart.easeOut
                    })
                ...
                if (i.bgDO) {
                    FWDS3DCovModTweenMax.to(i.bgDO, .8, {
                        x: u,
                        y: u,
                        w: s - u * 2,
                        h: o - u * 2,
                ...
                FWDS3DCovModTweenMax.to(i.mainDO, .8, {
                    w: s,
                    h: o,
                    ease: Quart.easeOut
                });
        ...
        this.setScaleInfinite = function(e) {
            ...
            if (!FWDS3DCovUtils.hasTransform2d) {
                ...
                if (i.borderDO) {
                    FWDS3DCovModTweenMax.to(i.borderDO, 0, {
                        w: t,
                        h: s,
                        ease: Quart.easeOut
                    })
                ...
                if (i.bgDO) {
                    FWDS3DCovModTweenMax.to(i.bgDO, 0, {
                        x: o,
                        y: o,
                        w: t - o * 2,
                        h: s - o * 2,
                ...
                FWDS3DCovModTweenMax.to(i.mainDO, 0, {
                    w: t,
                    h: s,
                    ease: Quart.easeOut
                });
                FWDS3DCovModTweenMax.to(i.imageHolderDO, 0, {
                    x: o,
                    y: o,
                    w: t - o * 2,
                    h: s - o * 2,
                ...
                if (i.imageDO) {
                    FWDS3DCovModTweenMax.to(i.imageDO, 0, {
                        w: t - o * 2,
                        h: s - o * 2,
                        ease: Quart.easeOut
                    })
        ...
        this.hide = function(e) {
            ...
            var n = i.thumbHeight - i.borderSize * 2;
            FWDS3DCovModTweenMax.to(i.imageHolderDO, .8, {
        ...
        this.onMouseOverHandler = function(e) {
            if (!i.isOver2 && i.id != r.curId) {
                i.isOver2 = true;
                if (r.showGradient && i.gradientDO) {
                    i.setGradient2(0)
                }
                FWDS3DCovModTweenMax.to(i, .6, {
                    z: i.curZ + r.thumbHoverOffset,
                    ease: Expo.easeOut
                })
            }
        }
        ...
        this.enable = function() {
            ...
            if (!i.isMobile && !i.screen.addEventListener) {
        ...
        this.disable = function() {
            ...
            if (i.isMobile) {
                ...
                if (i.screen.removeEventListener) {
                    ...
                    i.mainDO.screen.removeEventListener("mouseover", i.onMouseOverHandler);
                    i.mainDO.screen.removeEventListener("mouseout", i.onMouseOutHandler)
                } else {
                    i.mainDO.screen.detachEvent("onclick", i.onMouseClickHandler)
                }
            }
            clearTimeout(i.disableId);
            i.disableId = setTimeout(i.disableFinish, 800)
        }
        ;
        ...
        ;
        this.destroy = function() {
            FWDS3DCovModTweenMax.killTweensOf(i);
            FWDS3DCovModTweenMax.killTweensOf(i.mainDO);
            FWDS3DCovModTweenMax.killTweensOf(i.imageHolderDO);
            if (i.isMobile) {
                if (i.hasPointerEvent) {
                    i.mainDO.screen.removeEventListener("MSPointerUp", i.onMouseTouchHandler)
                } else {
            ...
            if (i.imageDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.imageDO);
            ...
            if (i.borderDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.borderDO);
                i.borderDO.destroy();
                i.borderDO = null 
            }
            if (i.gradientLeftDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.gradientLeftDO);
                i.gradientLeftDO.destroy();
                i.gradientLeftDO = null 
            }
            if (i.gradientRightDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.gradientRightDO);
                i.gradientRightDO.destroy();
                i.gradientRightDO = null 
            }
            if (i.textGradientDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.textGradientDO);
                i.textGradientDO = null 
            }
            if (i.textDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.textDO);
                i.textDO = null 
            }
            if (i.textHolderDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.textHolderDO);
                i.textHolderDO = null 
            }
            if (i.reflCanvasDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.reflCanvasDO);
                i.reflCanvasDO = null 
            }
    ...
    ;
    t.setPrototype = function() {
        t.prototype = new FWDS3DCovDisplayObject3D("div","absolute","visible")
    }
    ;
    t.CLICK = "click";
    t.prototype = null ;
...
(function(e) {
    var t = function(n, r) {
        ...
        this.infiniteLoop = n.infiniteLoop;
        this.dataListId = n.startAtCategory;
        this.curDataListAr;
        this.dragCurId;
        this.prevCurId;
        this.curId;
        this.startPos = n.coverflowStartPosition;
        ...
        this.textDO;
        this.controlsHeight = n.nextButtonNImg.height;
        this.controlsOffset = n.controlsOffset;
        this.showText = i.data.showText;
        this.textOffset = i.data.textOffset;
        this.thumbXSpace3D = n.thumbXSpace3D;
        this.thumbXOffset3D = n.thumbXOffset3D;
        this.thumbZSpace3D = n.thumbZSpace3D;
        this.thumbZOffset3D = n.thumbZOffset3D;
        this.thumbYAngle3D = n.thumbYAngle3D;
        this.thumbXSpace2D = n.thumbXSpace2D;
        this.thumbXOffset2D = n.thumbXOffset2D;
        this.thumbHoverOffset = n.thumbHoverOffset;
        this.topology = n.coverflowTopology;
        this.xRot = -n.coverflowXRotation;
        this.yRot = -n.coverflowYRotation;
        this.showGradient = n.showGradient;
        this.gradientColor1 = n.gradientColor1;
        this.gradientColor2 = n.gradientColor2;
        this.showTooltip = n.showTooltip;
        this.dynTooltip = n.dynTooltip;
        ...
        this.showControlsId;
        this.init = function() {
            i.thumbsHolderDO = new FWDS3DCovDisplayObject3D("div","absolute","visible");
            i.addChild(i.thumbsHolderDO);
            i.thumbsHolderDO.setZ(1e5);
            i.thumbsHolderDO.setX(Math.floor(i.stageWidth / 2));
            i.thumbsHolderDO.setY(Math.floor(i.stageHeight / 2));
            i.setWidth(i.stageWidth);
            i.setHeight(i.stageHeight);
            if (!i.isMobile && !FWDS3DCovUtils.isSafari || FWDS3DCovUtils.isAndroidAndWebkit) {
                i.thumbsHolderDO.setPreserve3D()
            }
            i.thumbsHolderDO.setAngleX(i.xRot);
            i.thumbsHolderDO.setAngleY(i.yRot);
            if (!i.isMobile) {
                if (i.screen.addEventListener) {
            ...
            if (i.nrThumbsToDisplay == 0) {
                i.infiniteLoop = false
            }
            i.showCurrentCat(-1);
            if (i.showText) {
                i.setupText()
        ...
        this.onThumbMove = function(e) {
            if (i.disableThumbClick)
                return;
            var t = FWDS3DCovUtils.getViewportMouseCoordinates(e);
            i.thumbMouseX = t.screenX - r.rect.left - (i.stageWidth - i.curDataListAr[i.curId].thumbWidth) / 2;
            i.thumbMouseY = t.screenY - r.rect.top - (i.stageHeight - i.thumbsMaxHeight + (i.thumbsMaxHeight - i.curDataListAr[i.curId].thumbHeight) * 2) / 2;
            if (i.showTooltip && !i.isTransition) {
                i.thumbsAr[i.curId].checkThumbOver(e)
            }
        }
        ;
        this.showCurrentCat = function(e) {
            ...
            i.setThumbsMaxHeight();
            i.setPerspectiveAndSizeRatio();
            i.setupThumbs();
            i.prevCurId = i.curId;
            i.startIntro()
        }
        ...
        this.setThumbsMaxHeight = function() {
            ...
            for (var e = 0; e < i.totalThumbs; e++) {
                if (i.curDataListAr[e].thumbHeight > i.thumbsMaxHeight) {
                    i.thumbsMaxHeight = i.curDataListAr[e].thumbHeight
                }
            }
        }
        ;
        this.setPerspectiveAndSizeRatio = function() {
            ...
            for (var t = 0; t < i.totalThumbs; t++) {
                e += i.curDataListAr[t].thumbWidth
            }
            i.avgThumbWidth = e / i.totalThumbs;
            i.perspective = i.avgThumbWidth * 4;
            i.sizeRatio = i.avgThumbWidth / 200;
        ...
        this.hideThumbs = function() {
            ...
            if (i.nrThumbsToDisplay > 0) {
                t = Math.floor(1e3 / i.nrThumbsToDisplay)
            } else {
                t = Math.floor(1e3 / r)
            }
            for (var s = 0; s < i.totalThumbs; s++) {
                thumb = i.thumbsAr[s];
                if (s == i.curId) {
                    i.hideThumbsFinishedId = setTimeout(i.hideThumbsFinished, 1e3 + 500)
                } else if (i.infiniteLoop) {
                    if (Math.abs(s - i.curId) <= i.nrThumbsToDisplay) {
                        e = Math.abs(i.nrThumbsToDisplay - Math.abs(s - i.curId) + 1) * t;
                        FWDS3DCovModTweenMax.to(thumb, .5, {
                            x: Math.floor(n),
                            delay: e / 1e3,
                            ease: Expo.easeIn
                        });
                        thumb.hide((e - 250) / 1e3)
                    } else if (Math.abs(Math.abs(s - i.curId) - i.totalThumbs) <= i.nrThumbsToDisplay) {
                        e = Math.abs(i.nrThumbsToDisplay - Math.abs(Math.abs(s - i.curId) - i.totalThumbs) + 1) * t;
                        FWDS3DCovModTweenMax.to(thumb, .5, {
                            x: Math.floor(n),
                            delay: e / 1e3,
                            ease: Expo.easeIn
                ...
                } else if (i.nrThumbsToDisplay > 0 && Math.abs(s - i.curId) <= i.nrThumbsToDisplay) {
                    e = Math.abs(i.nrThumbsToDisplay - Math.abs(s - i.curId) + 1) * t;
                    FWDS3DCovModTweenMax.to(thumb, .5, {
                        x: Math.floor(n),
                        delay: e / 1e3,
        ...
        this.hideThumbsFinished = function() {
            for (var e = 0; e < i.totalThumbs; e++) {
                ...
                if (e == i.curId) {
                    thumb.hide(0);
                    FWDS3DCovModTweenMax.to(thumb, .6, {
                        alpha: 0,
                        delay: .2,
                        onComplete: i.allThumbsAreTweened
                    });
                    if (i.textDO) {
                        FWDS3DCovModTweenMax.to(i.textDO, .6, {
                            alpha: 0,
                            delay: .2,
                            ease: Expo.easeOut
                        })
        ...
        this.destroyCurrentCat = function() {
            ...
            for (var t = 0; t < i.totalThumbs; t++) {
                e = i.thumbsAr[t];
                FWDS3DCovModTweenMax.killTweensOf(e);
        ...
        this.startIntro = function() {
            ...
            var e;
            var t;
            if (i.data.thumbsAlignment == "bottom") {
                e = -Math.floor(i.curDataListAr[i.curId].thumbWidth / 2);
                t = -Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[i.curId].thumbHeight)
            } else if (i.data.thumbsAlignment == "top") {
                e = -Math.floor(i.curDataListAr[i.curId].thumbWidth / 2);
                t = -Math.floor(i.thumbsMaxHeight / 2)
            } else {
                e = -Math.floor(i.curDataListAr[i.curId].thumbWidth / 2);
                t = -Math.floor(i.curDataListAr[i.curId].thumbHeight / 2)
            }
            thumb.setGradient(0);
            thumb.setX(Math.floor(e));
            thumb.setY(Math.floor(t));
            thumb.setAlpha(0);
            FWDS3DCovModTweenMax.to(thumb, .8, {
                alpha: 1
            });
        ...
        this.setupThumbs = function() {
            ...
            for (var t = 0; t < i.totalThumbs; t++) {
                ...
                e = new FWDS3DCovThumb(t,i.data,i);
                i.thumbsAr.push(e);
                e.addListener(FWDS3DCovThumb.CLICK, i.onThumbClick)
            }
        }
        ;
        ...
        this.resizeHandler = function(e) {
            ...
            i.positionControls();
            if (i.textDO) {
                i.textDO.setX(Math.floor((i.stageWidth - i.thumbWidth) / 2));
                if (i.data.thumbsAlignment == "bottom") {
                    i.textDO.setY(Math.floor(i.stageHeight / 2 + i.thumbsMaxHeight / 2 + i.textOffset - (1 - i.scale) * i.thumbsMaxHeight / 2))
                } else if (i.data.thumbsAlignment == "top") {
                    i.textDO.setY(Math.floor(i.stageHeight / 2 - i.thumbsMaxHeight / 2 + i.curDataListAr[i.curId].thumbHeight + i.textOffset - (1 - i.scale) * i.thumbsMaxHeight / 2))
                } else {
                    i.textDO.setY(Math.floor(i.stageHeight / 2 + i.curDataListAr[i.curId].thumbHeight / 2 + i.textOffset - (1 - i.scale) * i.thumbsMaxHeight / 2))
                }
            }
        }
        ;
        this.setupText = function() {
            i.textDO = new FWDS3DCovSimpleDisplayObject("div");
            i.addChild(i.textDO);
        ...
        this.addThumbText = function() {
            if (i.textDO) {
                ...
                i.textDO.setAlpha(0);
                FWDS3DCovModTweenMax.killTweensOf(i.textDO);
                FWDS3DCovModTweenMax.to(i.textDO, .8, {
                    alpha: 1,
                    ease: Expo.easeOut
                })
            }
        ...
        this.loadImages = function() {
            if (FWDS3DCovUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                i.setupIntro3D()
            } else {
                i.setupIntro2D()
            }
        ...
        this.loadThumbImageLeft = function() {
            if (i.countLoadedThumbsLeft < 0) {
                if (i.infiniteLoop) {
                    i.countLoadedThumbsLeft += i.totalThumbs
                } else {
                    return
                }
            }
            if (i.thumbsAr[i.countLoadedThumbsLeft].hasImage)
                return;
            i.thumbsAr[i.countLoadedThumbsLeft].hasImage = true;
        ...
        this.loadThumbImageRight = function() {
            if (i.countLoadedThumbsRight > i.totalThumbs - 1) {
                if (i.infiniteLoop) {
                    i.countLoadedThumbsRight -= i.totalThumbs
                } else {
                    return
                }
            }
            if (i.thumbsAr[i.countLoadedThumbsRight].hasImage)
                return;
            i.thumbsAr[i.countLoadedThumbsRight].hasImage = true;
        ...
        this.setupIntro3D = function() {
            ...
            for (var a = 0; a < i.totalThumbs; a++) {
                ...
                if (a != i.curId) {
                    if (i.data.thumbsAlignment == "bottom") {
                        e = -Math.floor(i.curDataListAr[a].thumbWidth / 2);
                        t = -Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[a].thumbHeight)
                    } else if (i.data.thumbsAlignment == "top") {
                        e = -Math.floor(i.curDataListAr[a].thumbWidth / 2);
                        t = -Math.floor(i.thumbsMaxHeight / 2)
                    } else {
                        e = -Math.floor(i.curDataListAr[a].thumbWidth / 2);
                        t = -Math.floor(i.curDataListAr[a].thumbHeight / 2)
                    }
                    thumb.setX(Math.floor(e));
                    thumb.setY(Math.floor(t))
                }
                ...
                case "onesided":
                    if (a != i.curId) {
                        if (i.nrThumbsToDisplay > 0 && Math.abs(a - i.curId) <= i.nrThumbsToDisplay) {
                            e = i.thumbXSpace3D * Math.abs(a - i.curId) + i.thumbXOffset3D;
                            if (a < i.curId) {
                                n = -((i.thumbZSpace3D + 1) * (a - i.curId) - i.thumbZOffset3D)
                            } else {
                                n = -((i.thumbZSpace3D + 1) * (a - i.curId) + i.thumbZOffset3D)
                            }
                            s = -i.thumbYAngle3D * f
                            ...
                            if (i.nrThumbsToDisplay > 0) {
                                e = i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D;
                                if (a < i.curId) {
                                    n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) * f - i.thumbZOffset3D)
                                } else {
                                    n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) * f + i.thumbZOffset3D)
                                }
                                s = -i.thumbYAngle3D * f;
                ...
                case "frontonesided":
                    if (a != i.curId) {
                        if (i.nrThumbsToDisplay > 0 && Math.abs(a - i.curId) <= i.nrThumbsToDisplay) {
                            ...
                            if (i.nrThumbsToDisplay > 0) {
                                e = i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D;
                                n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) + i.thumbZOffset3D);
                                s = -i.thumbYAngle3D * f;
                                if (a < i.curId) {
                                    e = 0;
                                    n = 1e3;
                ...
                case "accordion":
                    if (a != i.curId) {
                        if (i.nrThumbsToDisplay > 0 && Math.abs(a - i.curId) <= i.nrThumbsToDisplay) {
                            if (Math.abs(a - i.curId) % 2 == 0) {
                                e = i.avgThumbWidth * 3 / 4 * Math.abs(a - i.curId) * f;
                                n = -i.avgThumbWidth * Math.sqrt(3) / 4 * Math.abs(a - i.curId);
                                s = 0
                            } else {
                                e = (i.avgThumbWidth * 3 / 4 * (Math.abs(a - i.curId) - 1) + i.avgThumbWidth * 3 / 4) * f;
                                n = -i.avgThumbWidth * Math.sqrt(3) / 4 * Math.abs(a - i.curId);
                                s = 60 * f
                            }
                        } else {
                            if (i.nrThumbsToDisplay > 0) {
                                ...
                                s = -i.thumbYAngle3D * f;
                                if (Math.abs(a - i.curId) % 2 == 0) {
                                    e = i.avgThumbWidth * 3 / 4 * (i.nrThumbsToDisplay + 1) * f;
                                    n = -i.avgThumbWidth * Math.sqrt(3) / 4 * (i.nrThumbsToDisplay + 1);
                                    s = 0
                                } else {
                                    e = (i.avgThumbWidth * 3 / 4 * (i.nrThumbsToDisplay + 1 - 1) + i.avgThumbWidth * 3 / 4) * f;
                                    n = -i.avgThumbWidth * Math.sqrt(3) / 4 * (i.nrThumbsToDisplay + 1);
                                    s = 60 * f
                                }
                                o = 0
                ...
                default:
                    if (a != i.curId) {
                        if (i.infiniteLoop) {
                            if (Math.abs(a - i.curId) <= i.nrThumbsToDisplay) {
                                e = (i.thumbXSpace3D * Math.abs(a - i.curId) + i.thumbXOffset3D) * f;
                                n = -((i.thumbZSpace3D + 1) * Math.abs(a - i.curId) + i.thumbZOffset3D);
                                s = -i.thumbYAngle3D * f
                            } else if (Math.abs(Math.abs(a - i.curId) - i.totalThumbs) <= i.nrThumbsToDisplay) {
                                f *= -1;
                                e = (i.thumbXSpace3D * Math.abs(Math.abs(a - i.curId) - i.totalThumbs) + i.thumbXOffset3D) * f;
                                n = -((i.thumbZSpace3D + 1) * Math.abs(Math.abs(a - i.curId) - i.totalThumbs) + i.thumbZOffset3D);
                                s = -i.thumbYAngle3D * f
                            } else {
                                f = -i.getDir(a);
                                e = (i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D) * f;
                                n = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) + i.thumbZOffset3D);
                                s = -i.thumbYAngle3D * f;
                                o = 0
                            }
                ...
                if (i.topology != "accordion") {
                    e *= i.sizeRatio;
                    n *= i.sizeRatio
                }
                t = 0;
                if (i.data.thumbsAlignment == "bottom") {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[a].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[a].thumbHeight)
                } else if (i.data.thumbsAlignment == "top") {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[a].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2)
                } else {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[a].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.curDataListAr[a].thumbHeight / 2)
                }
                thumb.setZ(Math.floor(n));
                if (i.infiniteLoop) {
                    if (Math.abs(Math.abs(a - i.curId) - i.totalThumbs) <= i.nrThumbsToDisplay) {
                        u = Math.abs(Math.abs(a - i.curId) - i.totalThumbs) * Math.floor(1e3 / (i.totalThumbs / 2))
                    } else {
                        u = Math.abs(a - i.curId) * Math.floor(1e3 / (i.totalThumbs / 2))
                    }
                } else {
                    u = Math.abs(a - i.curId) * Math.floor(1e3 / (i.totalThumbs / 2))
                }
                ...
                thumb.setGradient(f);
                thumb.curZ = Math.floor(n);
                i.thumbsHolderDO.addChild(thumb)
            }
            if (FWDS3DCovUtils.isIEAndMoreThen9 || !FWDS3DCovUtils.hasTransform3d || i.data.showDisplay2DAlways) {
                i.sortZ()
            }
        ...
        this.setupIntro2D = function() {
            ...
            for (var s = 0; s < i.totalThumbs; s++) {
                ...
                if (i.nrThumbsToDisplay <= 0 || i.nrThumbsToDisplay > 13) {
                    i.nrThumbsToDisplay = 13
                }
                if (s != i.curId) {
                    if (i.infiniteLoop) {
                        if (Math.abs(s - i.curId) <= i.nrThumbsToDisplay) {
                            e = (i.thumbXSpace2D * Math.abs(s - i.curId) + i.thumbXOffset2D) * o;
                            n = Math.max(.9 - Math.abs(s - i.curId) * .05, .25);
                            r = Math.abs(s - i.curId) * Math.floor(1e3 / i.nrThumbsToDisplay);
                            thumb.setZIndex(i.nrThumbsToDisplay + 1 - Math.abs(s - i.curId))
                        } else if (Math.abs(Math.abs(s - i.curId) - i.totalThumbs) <= i.nrThumbsToDisplay) {
                            o *= -1;
                            e = (i.thumbXSpace2D * Math.abs(Math.abs(s - i.curId) - i.totalThumbs) + i.thumbXOffset2D) * o;
                            n = Math.max(.9 - Math.abs(Math.abs(s - i.curId) - i.totalThumbs) * .05, .25);
                            r = Math.abs(Math.abs(s - i.curId) - i.totalThumbs) * Math.floor(1e3 / i.nrThumbsToDisplay);
                            thumb.setZIndex(i.nrThumbsToDisplay + 1 - Math.abs(Math.abs(s - i.curId) - i.totalThumbs))
                        } else {
                            o = -i.getDir(s);
                            e = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * o;
                            n = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                            r = 0;
                            thumb.setAlpha(0);
                            thumb.setZIndex(0);
                            thumb.disable()
                    ...
                    thumb.setZIndex(i.nrThumbsToDisplay + 1)
                }
                e *= i.sizeRatio;
                if (i.data.thumbsAlignment == "bottom") {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[s].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[s].thumbHeight)
                } else if (i.data.thumbsAlignment == "top") {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[s].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2)
                } else {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[s].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.curDataListAr[s].thumbHeight / 2)
                }
                thumb.newX = Math.floor(e);
                thumb.newY = Math.floor(t);
                thumb.showThumbIntro2D(n, r / 1e3);
                thumb.setGradient(o);
                i.thumbsHolderDO.addChild(thumb)
            }
            i.setIntroFinishedId = setTimeout(i.setIntroFinished, r + 800);
            i.showControlsId = setTimeout(i.showControls, r)
        }
        ;
        ...
        this.gotoThumb = function() {
            ...
            i.isTransition = true;
            clearTimeout(i.transitionId);
            i.transitionId = setTimeout(i.setTransition, 800);
            if (FWDS3DCovUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                i.gotoThumb3D()
            } else {
                i.gotoThumb2D()
                    ...
                    if (a != i.curId) {
                        if (i.infiniteLoop) {
                            if (Math.abs(a - i.curId) <= i.nrThumbsToDisplay) {
                                ...
                                if (thumb.curAlpha == 0) {
                                    var l = -i.getDir(a);
                                    var c = (i.thumbXSpace3D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset3D) * l;
                                    var h = -((i.thumbZSpace3D + 1) * (i.nrThumbsToDisplay + 1) + i.thumbZOffset3D);
                                    var p = -i.thumbYAngle3D * l;
                                    c *= i.sizeRatio;
                                    h *= i.sizeRatio;
                                    c = Math.floor(c) - Math.floor(i.curDataListAr[a].thumbWidth / 2);
                                    thumb.setX(c);
                                    thumb.setZ(h);
                                    thumb.setAngleY(p)
                                }
        ...
        this.getDir = function(e) {
            var t;
            if (e < i.curId) {
                if (i.curId - e <= Math.floor(i.totalThumbs / 2)) {
                    t = 1
                } else {
                    t = -1
                }
            } else {
                if (e - i.curId <= Math.floor(i.totalThumbs / 2)) {
                    t = -1
                } else {
                    t = 1
                }
        ...
        this.gotoThumb2D = function() {
            ...
            for (var o = 0; o < i.totalThumbs; o++) {
                ...
                if (o != i.curId) {
                    if (i.infiniteLoop) {
                        if (Math.abs(o - i.curId) <= i.nrThumbsToDisplay) {
                            e = (i.thumbXSpace2D * Math.abs(o - i.curId) + i.thumbXOffset2D) * u;
                            n = Math.max(.9 - Math.abs(o - i.curId) * .05, .25);
                            if (thumb.curAlpha == 0) {
                                var a = -i.getDir(o);
                                var f = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * a;
                                var l = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                                f *= i.sizeRatio;
                                f = Math.floor(f) - Math.floor(i.curDataListAr[o].thumbWidth / 2);
                                thumb.newX = Math.floor(f);
                                thumb.setScaleInfinite(l)
                            }
                        } else if (Math.abs(Math.abs(o - i.curId) - i.totalThumbs) <= i.nrThumbsToDisplay) {
                            u *= -1;
                            e = (i.thumbXSpace2D * Math.abs(Math.abs(o - i.curId) - i.totalThumbs) + i.thumbXOffset2D) * u;
                            n = Math.max(.9 - Math.abs(Math.abs(o - i.curId) - i.totalThumbs) * .05, .25);
                            if (thumb.curAlpha == 0) {
                                var a = -i.getDir(o);
                                var f = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * a;
                                var l = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                            ...
                            u = -i.getDir(o);
                            e = (i.thumbXSpace2D * (i.nrThumbsToDisplay + 1) + i.thumbXOffset2D) * u;
                            n = Math.max(.9 - (i.nrThumbsToDisplay + 1) * .05, .25);
                            r = 0;
                            if (thumb.curAlpha == 0) {
                                s = false
                ...
                e *= i.sizeRatio;
                if (i.data.thumbsAlignment == "bottom") {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[o].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2) + (i.thumbsMaxHeight - i.curDataListAr[o].thumbHeight)
                } else if (i.data.thumbsAlignment == "top") {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[o].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.thumbsMaxHeight / 2)
                } else {
                    e = Math.floor(e) - Math.floor(i.curDataListAr[o].thumbWidth / 2);
                    t = Math.floor(t) - Math.floor(i.curDataListAr[o].thumbHeight / 2)
                }
                thumb.newX = Math.floor(e);
                thumb.newY = Math.floor(t);
                if (s) {
        ...
        this.sortZ = function() {
            ...
            for (var r = 0; r < i.totalThumbs; r++) {
                thumb = i.thumbsAr[r];
                var s = thumb.getX() + Math.floor(i.curDataListAr[r].thumbWidth / 2);
                if (Math.abs(s) < e) {
                    e = Math.abs(s);
                    t = r
                }
            }
            var o = i.thumbsAr[0].curX;
            var u = i.thumbsAr[i.totalThumbs - 1].curX;
            var a = 0;
            for (var r = 1; r < i.totalThumbs - 1; r++) {
                thumb = i.thumbsAr[r];
                if (thumb.curX == o || thumb.curX == u) {
                    a++
                }
            }
            if (a > i.totalThumbs / 2 && i.topology != "flipping" && FWDS3DCovUtils.hasTransform3d && !i.data.showDisplay2DAlways) {
                for (var r = 0; r < i.totalThumbs; r++) {
                    thumb = i.thumbsAr[r];
                    n = Math.floor(thumb.getZ());
                ...
                for (var r = 0; r < i.totalThumbs; r++) {
                    thumb = i.thumbsAr[r];
                    if (i.infiniteLoop) {
                        if (Math.abs(r - t) <= i.nrThumbsToDisplay) {
                            n = i.nrThumbsToDisplay + 1 - Math.abs(r - t)
                        } else if (Math.abs(Math.abs(r - t) - i.totalThumbs) <= i.nrThumbsToDisplay) {
                            n = i.nrThumbsToDisplay + 1 - Math.abs(Math.abs(r - t) - i.totalThumbs)
                        } else {
                            n = 0
                        }
                    } else {
                        if (i.nrThumbsToDisplay > 0) {
                            ...
                            n = Math.floor(i.totalThumbs / 2) - Math.abs(r - t)
                        }
                    }
                    if (n != thumb.getZIndex()) {
                        thumb.setZIndex(n)
        ...
        this.hideTooltip = function() {
            for (var e = 0; e < i.totalThumbs; e++) {
                i.thumbsAr[e].hideTooltip()
            }
        }
        ;
        this.setupControls = function() {
            i.controlsDO = new FWDS3DCovDisplayObject3D("div");
            ...
            if (i.showScrollbar) {
                ...
                var e = i.scrollbarDO.getX() + i.scrollbarDO.getWidth() + 1;
                if (i.showNextButton) {
                    i.nextButtonDO.setX(e);
                    e += i.nextButtonDO.getWidth() + 1
                }
        ...
        this.showControls = function() {
            if (i.data.controlsPos) {
                FWDS3DCovModTweenMax.to(i.controlsDO, .8, {
                    y: i.controlsOffset,
                    ease: Expo.easeOut
                })
            } else {
                FWDS3DCovModTweenMax.to(i.controlsDO, .8, {
                    y: i.stageHeight - i.controlsHeight - i.controlsOffset,
                    ease: Expo.easeOut
                })
            }
        }
        ...
        this.positionControls = function() {
            ...
            if (i.data.controlsPos) {
                i.controlsDO.setY(i.controlsOffset)
            } else {
                i.controlsDO.setY(i.stageHeight - i.controlsHeight - i.controlsOffset)
            }
        }
        ;
        this.setupPrevButton = function() {
            FWDS3DCovSimpleButton.setPrototype();
            i.prevButtonDO = new FWDS3DCovSimpleButton(i.data.prevButtonNImg,i.data.prevButtonSImg);
            i.prevButtonDO.addListener(FWDS3DCovSimpleButton.CLICK, i.prevButtonOnClickHandler);
        ...
        this.setupNextButton = function() {
            FWDS3DCovSimpleButton.setPrototype();
            i.nextButtonDO = new FWDS3DCovSimpleButton(i.data.nextButtonNImg,i.data.nextButtonSImg);
            i.nextButtonDO.addListener(FWDS3DCovSimpleButton.CLICK, i.nextButtonOnClickHandler);
            i.controlsDO.addChild(i.nextButtonDO);
            i.nextButtonDO.setX(i.controlsWidth + 1);
            i.controlsWidth += i.nextButtonDO.getWidth() + 1
        }
        ;
        ...
        this.setupSlideshowButton = function() {
            ...
            i.slideshowButtonDO = new FWDS3DCovSlideshowButton(i.data);
            i.slideshowButtonDO.addListener(FWDS3DCovSlideshowButton.PLAY_CLICK, i.onSlideshowButtonPlayClickHandler);
            i.slideshowButtonDO.addListener(FWDS3DCovSlideshowButton.PAUSE_CLICK, i.onSlideshowButtonPauseClickHandler);
            ...
            i.slideshowButtonDO.setX(i.controlsWidth + 1);
            i.controlsWidth += i.slideshowButtonDO.getWidth() + 1;
        ...
        this.setupScrollbar = function() {
            ...
            i.scrollbarDO = new FWDS3DCovScrollbar(i.data,i.totalThumbs,i.curId);
            i.scrollbarDO.addListener(FWDS3DCovScrollbar.MOVE, i.onScrollbarMove);
            i.controlsDO.addChild(i.scrollbarDO);
            i.scrollbarDO.setX(i.controlsWidth + 1);
            i.controlsWidth += i.scrollbarDO.getWidth() + 1
        }
        ;
        ...
        this.mouseWheelHandler = function(e) {
            if (!i.introFinished || !i.allowToSwitchCat)
                return;
            if (i.showScrollbar && i.scrollbarDO.isPressed)
                return;
        ...
        this.mobileDragStartTest = function(t) {
            var n = FWDS3DCovUtils.getViewportMouseCoordinates(t);
            if (n.screenY > i.controlsDO.getGlobalY())
                return;
        ...
        this.removeMobileDrag = function() {
            if (i.hasPointerEvent) {
                ...
                if (e.addEventListener) {
                    ...
                    e.removeEventListener("touchmove", i.mobileDragMoveTest);
                    e.removeEventListener("touchmove", i.mobileDragMoveHandler);
                    e.removeEventListener("touchend", i.mobileDragEndTest)
                }
            }
        }
        ...
        this.onKeyDownHandler = function(e) {
            ...
            if (i.showScrollbar && i.scrollbarDO.isPressed)
                return;
            if (r.lightboxDO && r.lightboxDO.isShowed_bl)
                return;
            if (document.removeEventListener) {
        ...
        this.destroy = function() {
            ...
            for (var n = 0; n < i.totalThumbs; n++) {
                FWDS3DCovModTweenMax.killTweensOf(i.thumbsAr[n]);
            ...
            if (i.thumbsHolderDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.thumbsHolderDO);
                i.thumbsHolderDO.destroy();
                i.thumbsHolderDO = null 
            }
            if (i.controlsDO) {
                FWDS3DCovModTweenMax.killTweensOf(i.controlsDO);
...
(function(e) {
    var t = function(e) {
        ...
        ;
        this.setupText = function() {
            n.tooltipMainDO = new FWDS3DCovDisplayObject("div");
            n.addChild(n.tooltipMainDO);
            n.tooltipHolderDO = new FWDS3DCovDisplayObject("div");
            n.tooltipMainDO.addChild(n.tooltipHolderDO);
            n.tooltipHolderDO.setWidth(1e3);
            n.tooltipTextDO = new FWDS3DCovSimpleDisplayObject("div");
            n.tooltipHolderDO.addChild(n.tooltipTextDO);
            n.tooltipTextDO.getStyle().fontSmoothing = "antialiased";
            n.tooltipTextDO.getStyle().webkitFontSmoothing = "antialiased";
            n.tooltipTextDO.getStyle().textRendering = "optimizeLegibility";
            n.tooltipTextDO.setInnerHTML(n.text);
            n.setTextWidthId = setTimeout(n.setTextWidth, 10)
        }
        ;
        this.setTextWidth = function() {
            if (n.tooltipTextDO.getWidth() > n.tooltipMaxWidth) {
                n.tooltipTextDO.setWidth(n.tooltipMaxWidth);
                n.setTextHeightId = setTimeout(n.setTextHeight, 10)
            } else {
                n.textWidth = n.tooltipTextDO.getWidth();
                n.textHeight = n.tooltipTextDO.getHeight();
                n.setupTooltip()
            }
        }
        ;
        ...
        ;
        this.setupTooltip = function() {
            n.tooltipCenterDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipCenterDO.screen.src = e.skinPath + "/center.png";
            n.tooltipHolderDO.addChild(n.tooltipCenterDO);
            n.tooltipCenterDO.setWidth(n.textWidth + n.tooltipShadowOffset * 2 + 2);
            n.tooltipCenterDO.setHeight(n.textHeight + n.tooltipShadowOffset * 2 + 2);
            n.tooltipCenterDO.setX(n.tooltipMarginSpace - 1);
            n.tooltipCenterDO.setY(n.tooltipMarginSpace - 1);
            n.tooltipTopDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipTopDO.screen.src = e.skinPath + "/top.png";
            n.tooltipHolderDO.addChild(n.tooltipTopDO);
            n.tooltipTopDO.setWidth(n.textWidth + n.tooltipMarginSpace * 2);
            n.tooltipTopDO.setHeight(n.tooltipMarginSpace);
            n.tooltipTopDO.setX(n.tooltipShadowOffset);
            n.tooltipLeftDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipLeftDO.screen.src = e.skinPath + "/left.png";
            n.tooltipHolderDO.addChild(n.tooltipLeftDO);
            n.tooltipLeftDO.setWidth(n.tooltipMarginSpace);
            n.tooltipLeftDO.setHeight(n.textHeight + n.tooltipMarginSpace * 2);
            n.tooltipLeftDO.setY(n.tooltipShadowOffset);
            n.tooltipRightDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipRightDO.screen.src = e.skinPath + "/right.png";
            n.tooltipHolderDO.addChild(n.tooltipRightDO);
            n.tooltipRightDO.setWidth(n.tooltipMarginSpace);
            n.tooltipRightDO.setHeight(n.textHeight + n.tooltipMarginSpace * 2);
            n.tooltipRightDO.setX(n.textWidth + n.tooltipMarginSpace + n.tooltipShadowOffset * 2);
            n.tooltipRightDO.setY(n.tooltipShadowOffset);
            n.tooltipBottomDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipBottomDO.screen.src = e.skinPath + "/bottom.png";
            n.tooltipHolderDO.addChild(n.tooltipBottomDO);
            n.tooltipBottomDO.setWidth(n.textWidth + n.tooltipMarginSpace * 2);
            n.tooltipBottomDO.setHeight(n.tooltipMarginSpace);
            n.tooltipBottomDO.setX(n.tooltipShadowOffset);
            n.tooltipBottomDO.setY(n.textHeight + n.tooltipMarginSpace + n.tooltipShadowOffset * 2);
            n.image1 = new Image;
            n.image1.onload = n.onPointerBottomLoad;
            n.image1.src = e.skinPath + "/pointerBottom.png";
            n.tooltipHolderDO.addChild(n.tooltipTextDO);
            n.tooltipTextDO.setX(n.tooltipMarginSpace + n.tooltipShadowOffset);
            n.tooltipTextDO.setY(n.tooltipMarginSpace + n.tooltipShadowOffset)
        }
        ;
        this.onPointerBottomLoad = function() {
            n.tooltipPointerBottomDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipPointerBottomDO.setScreen(n.image1);
            n.tooltipMainDO.addChild(n.tooltipPointerBottomDO);
            n.pointerWidth = n.tooltipPointerBottomDO.getWidth();
            n.pointerHeight = n.tooltipPointerBottomDO.getHeight();
            n.tooltipPointerBottomDO.setX(Math.floor((n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2 - n.pointerWidth) / 2));
            n.tooltipPointerBottomDO.setY(n.textHeight + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset);
            n.image2 = new Image;
            n.image2.onload = n.onPointerTopLoad;
            n.image2.src = e.skinPath + "/pointerTop.png"
        }
        ;
        this.onPointerTopLoad = function() {
            n.tooltipPointerTopDO = new FWDS3DCovSimpleDisplayObject("img");
            n.tooltipPointerTopDO.setScreen(n.image2);
            n.tooltipMainDO.addChild(n.tooltipPointerTopDO);
            n.tooltipPointerTopDO.setX(-500);
            n.tooltipPointerTopDO.setX(Math.floor((n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2 - n.pointerWidth) / 2));
            n.tooltipPointerTopDO.setY(n.tooltipShadowOffset);
            n.tooltipHolderDO.setWidth(n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2);
            n.tooltipHolderDO.setHeight(n.textHeight + 2 * n.tooltipMarginSpace + n.pointerHeight);
            n.tooltipMainDO.setWidth(n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2);
            n.tooltipMainDO.setHeight(n.textHeight + 2 * n.tooltipMarginSpace + n.pointerHeight + n.tooltipShadowOffset * 2);
            n.tooltipMainDO.setX(-Math.floor(n.tooltipMainDO.getWidth() / 2));
            n.tooltipMainDO.setY(-n.tooltipMainDO.getHeight());
            n.tooltipOverDO = new FWDS3DCovDisplayObject("div");
            n.addChild(n.tooltipOverDO);
            n.tooltipOverDO.setWidth(n.textWidth + 2 * n.tooltipMarginSpace);
            n.tooltipOverDO.setHeight(n.textHeight + 2 * n.tooltipMarginSpace + n.pointerHeight);
            n.tooltipOverDO.setX(-Math.floor(n.tooltipMainDO.getWidth() / 2));
            n.tooltipOverDO.setY(-n.tooltipMainDO.getHeight());
            if (n.btnMode) {
                n.setButtonMode(true)
            }
            n.tooltipWidth = n.textWidth + 2 * n.tooltipMarginSpace;
            n.tooltipHeight = n.textHeight + 2 * n.tooltipMarginSpace + n.pointerHeight
        }
        ;
        this.getTooltipWidth = function() {
            return n.tooltipWidth
        }
        ;
        this.getTooltipHeight = function() {
            return n.tooltipHeight
        }
        ;
        this.setPointerDX = function(e) {
            if (n.pointerDX == e)
                return;
            n.pointerDX = e;
            if (n.tooltipPointerBottomDO) {
                n.tooltipPointerBottomDO.setX(Math.floor((n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2 - n.pointerWidth) / 2 + n.pointerDX))
            }
            if (n.tooltipPointerTopDO) {
                n.tooltipPointerTopDO.setX(Math.floor((n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2 - n.pointerWidth) / 2 + n.pointerDX))
            }
        }
        ;
        this.swapTooltip = function(e) {
            n.tooltipSwapped = e;
            if (n.tooltipSwapped) {
                n.tooltipMainDO.setY(0);
                n.tooltipHolderDO.setY(n.pointerHeight);
                if (n.tooltipOverDO) {
                    n.tooltipOverDO.setY(0)
                }
                if (n.tooltipPointerTopDO) {
                    n.tooltipPointerTopDO.setX(Math.floor((n.textWidth + 2 * n.tooltipMarginSpace + n.tooltipShadowOffset * 2 - n.pointerWidth) / 2 + n.pointerDX))
                }
                if (n.tooltipPointerBottomDO) {
                    n.tooltipPointerBottomDO.setX(-500)
                }
            } else {
                n.tooltipMainDO.setY(-n.tooltipMainDO.getHeight());
                n.tooltipHolderDO.setY(0);
                if (n.tooltipOverDO) {
                    n.tooltipOverDO.setY(-n.tooltipMainDO.getHeight())
                }
                if (n.tooltipPointerTopDO) {
        ...
        ;
        this.destroy = function() {
            clearTimeout(n.setTextWidthId);
            clearTimeout(n.setTextHeightId);
            n.tooltipMainDO.destroy();
            n.tooltipTopDO.destroy();
            n.tooltipBottomDO.destroy();
            n.tooltipCenterDO.destroy();
            n.tooltipLeftDO.destroy();
            n.tooltipRightDO.destroy();
            n.tooltipHolderDO.destroy();
            n.tooltipPointerBottomDO.destroy();
            n.tooltipPointerTopDO.destroy();
            n.tooltipTextDO.destroy();
            n.tooltipOverDO.destroy();
            n.tooltipMainDO = null ;
            n.tooltipTopDO = null ;
            n.tooltipBottomDO = null ;
            n.tooltipCenterDO = null ;
            n.tooltipLeftDO = null ;
            n.tooltipRightDO = null ;
            n.tooltipHolderDO = null ;
            n.tooltipPointerBottomDO = null ;
            n.tooltipPointerTopDO = null ;
            n.tooltipTextDO = null ;
            n.tooltipOverDO = null ;
            n.setInnerHTML("");
            r.destroy();
            n = null ;
            r = null ;
...
(function(e) {
    ...
    t.hitTest = function(e, t, n) {
        var r = false;
        if (!e)
            throw Error("Hit test target is null!");
        var i = e.getBoundingClientRect();
        if (t >= i.left && t <= i.right && n >= i.top && n <= i.bottom)
            return true;
        return false
    }
    ;
...
(function(e) {
    var t = function(n) {
        ...
        this.init = function() {
            ...
            if (!r.propsObj.coverflowHolderDivId) {
                alert("Property coverflowHolderDivId is not defined in the FWDSimple3DCoverflow object constructor!");
                return
            }
            if (!FWDS3DCovUtils.getChildById(r.propsObj.coverflowHolderDivId)) {
                alert("FWDSimple3DCoverflow holder div is not found, please make sure that the div exists and the id is correct! " + r.propsObj.coverflowHolderDivId);
                return
            }
            if (!r.propsObj.coverflowWidth) {
            ...
            r.stageContainer = FWDS3DCovUtils.getChildById(r.propsObj.coverflowHolderDivId);
            r.autoScale = r.propsObj.autoScale == "yes" ? true : false;
            r.originalWidth = r.propsObj.coverflowWidth;
            r.originalHeight = r.propsObj.coverflowHeight;
            r.setupMainDO();
            r.setupInfo();
            r.setupData();
        ...
        this.setupMainDO = function() {
            r.mainDO = new FWDS3DCovDisplayObject("div","relative");
            ...
            if (r.displayType == t.FLUID_WIDTH) {
                ...
                if (FWDS3DCovUtils.isIE7) {
                    ...
                    r.mainDO.screen.id = r.propsObj.coverflowHolderDivId + "-fluidwidth"
                }
            } else {
        ...
        this.setBackgrounds = function() {
            if (r.propsObj.backgroundImagePath) {
                r.bgDO = new FWDS3DCovDisplayObject("div");
                ...
                r.bgDO.setAlpha(0);
                FWDS3DCovModTweenMax.to(r.bgDO, .8, {
                    alpha: 1
                })
            }
        }
        ...
        this.resizeHandler = function() {
            if (!r.orientationChangeComplete)
                return;
            var e = FWDS3DCovUtils.getScrollOffsets();
            var n = FWDS3DCovUtils.getViewportSize();
            ...
            if (r.categoriesMenuDO) {
                r.categoriesMenuDO.position()
            }
        }
        ;
        this.setupContextMenu = function() {
            r.customContextMenuDO = new FWDS3DCovContextMenu(r.mainDO,r.data.rightClickContextMenu)
        }
        ;
        this.setupData = function() {
            FWDS3DCovData.setPrototype();
            r.data = new FWDS3DCovData(r.propsObj);
            r.data.addListener(FWDS3DCovData.PRELOADER_LOAD_DONE, r.onPreloaderLoadDone);
            r.data.addListener(FWDS3DCovData.LOAD_ERROR, r.dataLoadError);
            r.data.addListener(FWDS3DCovData.LOAD_DONE, r.dataLoadComplete)
        }
        ;
        ...
        this.dataLoadComplete = function(e) {
            ...
            if (r.data.showCategoriesMenu) {
                r.setupCategoriesMenu()
            }
        ...
        this.setupPreloader = function() {
            FWDS3DCovPreloader.setPrototype();
            r.preloaderDO = new FWDS3DCovPreloader(r.data.mainPreloaderImg,85,36,20,50);
        ...
        this.positionPreloader = function() {
            if (r.preloaderDO) {
                ...
                r.preloaderDO.setY(parseInt((r.stageHeight - r.preloaderDO.getHeight()) / 2) + 7)
            }
        }
        ;
        this.setupThumbsManager = function() {
            FWDS3DCovThumbsManager.setPrototype();
            r.thumbsManagerDO = new FWDS3DCovThumbsManager(r.data,r);
            r.thumbsManagerDO.addListener(FWDS3DCovThumbsManager.THUMB_CLICK, r.onThumbsManagerThumbClick);
            r.thumbsManagerDO.addListener(FWDS3DCovThumbsManager.LOAD_ERROR, r.onThumbsManagerLoadError);
            r.thumbsManagerDO.addListener(FWDS3DCovThumbsManager.THUMBS_INTRO_FINISH, r.onThumbsManagerIntroFinish);
            r.thumbsManagerDO.addListener(FWDS3DCovThumbsManager.THUMB_CHANGE, r.onThumbsManagerThumbChange);
        ...
        ;
        this.setPreset = function(e) {
            r.thumbsManagerDO.setPreset(e)
        }
        ;
        this.setupCategoriesMenu = function() {
            FWDS3DCovCategoriesMenu.setPrototype();
            r.categoriesMenuDO = new FWDS3DCovCategoriesMenu(r,r.data.categoriesAr,r.data.startAtCategory,r.data.catMaxWidth,21,r.data.catOffset,r.data.catColorNormal,r.data.catColorSelected);
            r.categoriesMenuDO.addListener(FWDS3DCovCategoriesMenu.CHANGE, r.onCategoriesMenuChange);
            r.mainDO.addChild(r.categoriesMenuDO)
        }
        ;
        ...
        this.setupDisable = function() {
            r.disableDO = new FWDS3DCovDisplayObject3D("div");
        ...
        this.destroy = function() {
            ...
            if (r.bgDO) {
                FWDS3DCovModTweenMax.killTweensOf(r.bgDO);
                r.bgDO.destroy()
            }
            if (r.categoriesMenuDO) {
                r.categoriesMenuDO.destroy()
            }
            if (r.disableDO) {
                r.disableDO.destroy()
            }
